...
// import PVtimer from '../components/PVtimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>If <b>p</b>=(-2,1,3),<b>q</b>=(-2,3,1),<b>r</b>=(3,-2,4) and <b>j</b> is the unit vector in the direction of y-axis, then (2<b>p</b>+3<b>q</b>+4<b>r</b>).<b>j</b>=
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/PVtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (PVone)