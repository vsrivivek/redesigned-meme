...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>If <b>a</b>=-<b>i</b>+<b>j</b>+2<b>k</b>,<b>b</b>=2<b>i</b>-<b>j</b>-<b>k</b> and <b>c</b>=-2<b>i</b>+<b>j</b>+3<b>k</b> , then the angle between 2<b>a</b>-<b>c</b> and <b>a</b>+<b>b</b> is:
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVfour)