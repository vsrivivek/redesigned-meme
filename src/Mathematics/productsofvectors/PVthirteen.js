...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br>If <b>a</b>=<b>i</b>+<b>j</b>+<b>k</b>,<b>b</b>=2<b>i</b>-3<b>j</b>+<b>k</b> then <b>a</b>x<b>b</b> is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirteen)