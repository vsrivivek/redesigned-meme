...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br>The volume of the parallelopiped whose coterminal edges are 2<b>i</b>-3<b>j</b>+4<b>k</b>,<b>i</b>+2<b>j</b>-2<b>k</b>,3<b>i</b>-<b>j</b>+<b>k</b>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirty)