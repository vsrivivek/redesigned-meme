...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>The angle between the vectors 6<b>i</b>+2<b>j</b>+<b>k</b>,2<b>i</b>-9<b>j</b>+6<b>k</b> is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVfive)