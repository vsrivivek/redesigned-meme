...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>If the position vectors of A,B,C,D are respectively (-6,1,6),(6,-2,3),(-2,-3,-1) and (-5,-9,-7), then
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVsix)