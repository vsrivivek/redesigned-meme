...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>If <b>a</b>= <b>i</b>-<b>j</b>-6<b>k</b>, <b>b</b>= <b>i</b>-3<b>j</b>+4<b>k</b>, <b>c</b>= 2<b>i</b>-5<b>j</b>+3<b>k</b> then [<b>a</b> <b>b</b> <b>c</b>]= 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVtwentyseven)