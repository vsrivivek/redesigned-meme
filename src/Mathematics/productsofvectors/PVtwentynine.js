...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>   If <b>a</b>,<b>b</b> and <b>c</b> are mutually perpendicular unit vectors then [<b>a</b> <b>b</b> <b>c</b>]<sup>2</sup>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVtwentynine)