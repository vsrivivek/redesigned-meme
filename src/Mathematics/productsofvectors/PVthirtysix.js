...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br>   The position vectors of three noncollinear points A,B,C are <b>a</b>,<b>b</b>,<b>c</b> respectively. The distance of the plane through A,B,C from the origin is  
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> |[<b>a</b> <b>b</b> <b>c</b>]|/|<b>a</b>x<b>b</b> <b>b</b>x<b>c</b> <b>c</b>x<b>a</b>|    </div>
       
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirtysix)