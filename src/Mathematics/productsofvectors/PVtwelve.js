...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> The length of projection  of 2<b>i</b>-3<b>j</b>+<b>k</b> , in the direction of  4<b>i</b>-4<b>j</b>+7<b>k</b> is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVtwelve)