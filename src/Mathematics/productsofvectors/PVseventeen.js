...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>A unit vector perpendicular to the plane determined by the points P(1,-1,2), Q(2,0,-1) and R(0,2,1) is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVseventeen)