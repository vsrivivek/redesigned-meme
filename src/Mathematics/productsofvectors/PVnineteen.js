...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.19</i><br></br>  If (2<b>i</b>+4<b>j</b>+2<b>k</b>)x(2<b>i</b>-x<b>j</b>+5<b>k</b>)= 16<b>i</b>-6<b>j</b>+2x<b>k</b>, then the value of x is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVnineteen)