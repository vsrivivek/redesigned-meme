...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <form>
    <p><i>Question No.32</i><br></br>If <b>d</b>= x(<b>a</b>x<b>b</b>)+y(<b>b</b>x<b>c</b>)+z(<b>c</b>x<b>a</b>) and [<b>a</b> <b>b</b> <b>c</b>] =1/8, then x+y+z=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirtytwo)