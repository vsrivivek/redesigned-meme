...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>If θ is the angle between  the vectors <b>a</b>=2<b>i</b>-<b>j</b>+<b>k</b> and <b>b</b>=<b>i</b>+2<b>j</b>+<b>k</b>, then cosθ=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVeight)