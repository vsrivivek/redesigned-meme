...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>If <b>a</b>,<b>b</b>,<b>c</b> be unit vectors such that <b>a</b>.<b>b</b>=<b>a</b>.<b>c</b>=0 and the angle between <b>b</b> and <b>c</b> is π/6, then <b>a</b>=</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVtwentyfive)