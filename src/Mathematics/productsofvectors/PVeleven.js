...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    If  <b>a</b>=<b>i</b>+2<b>j</b>+3<b>k</b>,<b>b</b>=-<b>i</b>+2<b>j</b>+<b>k</b>,<b>c</b>=3<b>i</b>+<b>j</b> and <b>a</b>+t<b>b</b> is perpendicular to <b>c</b> then  t=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVeleven)