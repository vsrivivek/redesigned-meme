...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>If the vectors <b>i</b>+3<b>j</b>+4<b>k</b>,λ<b>i</b>-4<b>k</b>+<b>k</b> are orthogonal to each other,then  λ=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVten)