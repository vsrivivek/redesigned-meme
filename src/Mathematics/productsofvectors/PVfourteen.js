...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br> If (<b>a</b>x<b>b</b>)<sup>2</sup>+(<b>a</b>.<b>b</b>)<sup>2</sup>=144 and |<b>a</b>|=4 then |<b>b</b>|=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVfourteen)