...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br>The number of vectors of unit length perpendicular to the vectors <b>a</b>= (1,1,0) and <b>b</b>=(0,1,1) is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVsixteen)