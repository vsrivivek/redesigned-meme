...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.9</i><br></br>If the position vectors of  A,B and C are respectively 2<b>i</b>-<b>j</b>+<b>k</b>,<b>i</b>-3<b>j</b>-5<b>k</b> and 3<b>i</b>-4<b>j</b>-4<b>k</b>, then cos<sup>2</sup>A=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVnine)