...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>The cartesian equation of the plane passing through the point(3,-2,-1) and parallel to the vectors <b>b</b>=<b>i</b>-2<b>j</b>+4<b>k</b> and <b>c</b>= 3<b>i</b>+2<b>j</b>-5<b>k</b>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirtyfive)