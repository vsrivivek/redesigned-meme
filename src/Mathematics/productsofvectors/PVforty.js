...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> [<b>b</b>{'\u00d7'}<b>c</b> <b>c</b>{'\u00d7'}<b>a</b> <b>a</b>{'\u00d7'}<b>b</b>]=
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVforty)