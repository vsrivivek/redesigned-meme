...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>The equation to the plane containing the lines <b>r</b>=<b>a</b>+t<b>b</b>, <b>r</b>=<b>b</b>+s<b>a</b> is 
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> <b>r</b>.<b>b</b>= <b>a</b>.<b>b</b>
        
      </div>
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirtyfour)