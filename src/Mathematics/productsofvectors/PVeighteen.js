...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br> The sine of the angle between the vectors <b>i</b>+3<b>j</b>+2<b>k</b>, 2<b>i</b>-4<b>j</b>-<b>k</b> is 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVeighteen)