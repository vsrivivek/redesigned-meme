...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br>  [<b>i</b>-<b>j</b> <b>j</b>-<b>k</b> <b>k</b>-<b>i</b>]=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVtwentysix)
