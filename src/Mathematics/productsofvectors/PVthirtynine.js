...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br> If <b>a</b>=<b>i</b>+<b>j</b>+<b>k</b>, <b>b</b>=<b>i</b>+<b>j</b>, <b>c</b>=<b>i</b> and (<b>a</b>{'\u00d7'}<b>b</b>){'\u00d7'}<b>c</b>={'\u03bb'}<b>a</b>+{'\u03bc'}<b>b</b>, then {'\u03bb'}+{'\u03bc'}=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PVforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PVforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PVforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PVthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PVthirtynine)