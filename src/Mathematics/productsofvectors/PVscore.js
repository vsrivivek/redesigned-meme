...
const button=<button style={wStyle1} onClick={()=>navigate('/PVsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (PVscore)