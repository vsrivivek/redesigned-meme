...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br>   1.2+2.3+3.4+.....n terms=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIfifteen)