...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> If [1/(2×4)]+[1/(4×6)]+[1/(6×8)]+⋯(n terms)=kn/(n+1 ) then k=
</p>
      <div >
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIforty)