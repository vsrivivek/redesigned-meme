...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>1+3+7+15....... n terms=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIsix)