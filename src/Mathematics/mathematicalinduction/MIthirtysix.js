...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br> The sum of first 9 terms of the series [1<sup>3</sup>/3]+[(1<sup>3</sup>+2<sup>3</sup>)/(1+3)]+[(1<sup>3</sup>+2<sup>3</sup>+3<sup>3</sup>)/(1+3+5)]+........ is=      
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthirtysix)