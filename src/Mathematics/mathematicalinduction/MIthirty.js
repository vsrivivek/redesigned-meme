...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br> (1)+(2+3)+(4+5+6)+...... n brackets
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthirty)