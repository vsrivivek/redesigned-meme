...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br>  If  s<sub>n</sub>=1<sup>3</sup>+2<sup>3</sup>+.......+n<sup>3</sup> and T<sub>n</sub>=1+2+⋯+n then
      ...
      <div>
        ...
        /> s<sub>n</sub>=T<sub>n<sup>3</sup></sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> s<sub>n</sub>=T<sub>n<sup>2</sup></sub> 
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> s<sub>n</sub>=T<sup>2</sup><sub>n</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthirteen)