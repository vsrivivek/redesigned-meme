...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>  [1.2<sup>2</sup>+2.3<sup>2</sup>+3.4<sup>2</sup>+......n(n+1)<sup>2</sup>]/[1<sup>2</sup>.2+2<sup>2</sup>.3+3<sup>2</sup>.4+.......n<sup>2</sup> (n+1)] =
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthirtyeight)