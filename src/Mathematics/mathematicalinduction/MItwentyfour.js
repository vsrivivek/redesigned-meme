...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentythree()
    ...
    <form>
    <p><i>Question No.24</i><br></br>  1.4.7+4.7.10+7.10.13+........ n terms
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> [n(27n<sup>3</sup>+90n<sup>2</sup>+45n-50)]/4		
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentyfour)