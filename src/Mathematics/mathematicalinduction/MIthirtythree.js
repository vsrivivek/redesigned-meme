...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> (1)+(2+3+4)+(5+6+7+8+9)+....... n brackets
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthirtythree)