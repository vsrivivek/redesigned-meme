...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>2.3.1+3.4.4+4.5.7+......... n terms
      ...
      <div>
        ...
        /> n/12 [9n<sup>3</sup>+46n<sup>2</sup>+51n-34]        
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentyfive)