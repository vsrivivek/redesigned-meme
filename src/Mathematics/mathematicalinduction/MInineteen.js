...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br> 3.6+4.7+5.8+......(n-2) terms=
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> [2n<sup>3</sup>+12n<sup>2</sup>+10n-84]/6     
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MInineteen)