...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>(1)+(1+3)+(1+3+5)+.......n brackets=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentyseven)