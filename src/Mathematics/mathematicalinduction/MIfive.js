...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>  1+4+10+19+......+(3n<sup>2</sup>-3n+2)/2=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIfive)