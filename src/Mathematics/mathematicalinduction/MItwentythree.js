...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br>  1.3.4+2.4.5+3.5.6+......+n terms </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> [n(27n<sup>3</sup>+90n<sup>3</sup>+45n-50)]/4		
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentythree)