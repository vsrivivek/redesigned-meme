...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br>(1)+(1+2+)+(1+2+3)+.......n brackets=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentysix)
