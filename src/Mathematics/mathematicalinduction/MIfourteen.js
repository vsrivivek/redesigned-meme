...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br>1<sup>3</sup>+1<sup>2</sup>+1+2<sup>3</sup>+2<sup>2</sup>+2+3<sup>3</sup>+3<sup>2</sup>+3+⋯3n terms=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIfourteen)