...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> 1<sup>3</sup>+2<sup>3</sup>+3<sup>3</sup>+⋯+100<sup>3</sup>= k<sup>2</sup>,then k=  
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwelve)