...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br>(1<sup>2</sup>)+(1<sup>2</sup>+2<sup>2</sup> )+(1<sup>2</sup>+2<sup>2</sup>+3<sup>2</sup> )+...................n brackets
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwentyteight)