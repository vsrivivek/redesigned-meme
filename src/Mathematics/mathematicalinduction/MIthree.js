...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br>(Σn<sup>3</sup>)(Σn)=(Σn<sup>2</sup>)<sup>2</sup> if
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MItwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIthree)