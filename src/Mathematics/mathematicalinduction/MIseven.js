...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> 3+13+29+51+79+........=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIseven)