...
// import MItimer from '../components/MItimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>n th term of 3+5+9+17+...... is
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/MItwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MItwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MItwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (MIone)