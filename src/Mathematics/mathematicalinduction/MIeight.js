...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br> 1+4+13+40+........n terms
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MInine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MInine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MInine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MIeight)