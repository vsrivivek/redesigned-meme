...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br>  1.3+2.3<sup>2</sup>+3.3<sup>3</sup>+..........n.3<sup>n</sup>=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MInine)