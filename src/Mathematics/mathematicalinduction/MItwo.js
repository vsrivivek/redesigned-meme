...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>2+3+5+6+8+9+......2n terms=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MIthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MIthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MIthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MIone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (MItwo)