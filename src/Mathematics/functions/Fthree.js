...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br>Set A has 3 elements and set B has 4 elements. The number of injections that can be defined from A into B is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ffour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ffour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ffour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthree)