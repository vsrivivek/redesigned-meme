...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> Domain of sinx-e<sup>{'\u221a'}x</sup>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtythree)