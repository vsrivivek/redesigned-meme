...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br> If f:(3,6){'\u2192'}(1,3) is a function defined by f(x)= x-[x/3] then f{'\u207b'}{'\u00b9'}(x)=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtyfive)