...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Set A has n elements. The number of functions of that can be defined from A into A
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwo)