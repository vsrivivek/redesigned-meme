...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>The range of the function <sup>7-x</sup>P<sub>x-3</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwentyseven)