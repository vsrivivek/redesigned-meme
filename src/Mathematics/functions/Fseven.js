...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> The domain of √(x<sup>2</sup>-25)   is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Feight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Feight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Feight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fseven)