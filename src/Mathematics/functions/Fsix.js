...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>The domain of √(4-x{'\u00b2'} )  is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ffive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fsix)