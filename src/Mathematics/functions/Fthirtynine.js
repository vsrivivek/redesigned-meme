...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br> If f : A{'\u2192'}B and If g : B{'\u2192'}C are functions such that gof : A{'\u2192'}C is onto, then a necessary condition is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtynine)