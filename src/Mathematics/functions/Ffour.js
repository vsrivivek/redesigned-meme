...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>The domain of1/(|x|-x)  is
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/Ffive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ffive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ffive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ffour)