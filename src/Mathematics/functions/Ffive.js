...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br> The domain of the function of f(x)=1/√(|x|-x) is:
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ffour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ffive)