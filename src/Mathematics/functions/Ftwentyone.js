...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br> If f(x)= x{'\u00b2'}-2x+4 then the set of values of x satisfying f(x-1)= f(x+1) is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (FtwentyOne)