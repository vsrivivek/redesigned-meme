...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    <form>
    <p><i>Question No.11</i><br></br> For any integer n{'\u2265'}1 , the number of positive divisors of n is denoted by d(n). Then for a prime p, d(d(d(p{'\u2077'})))
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ften'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Feleven)