...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>  If a{'\u00b2'}+b{'\u00b2'}+c{'\u00b2'}= 2, then the range of ab+bc+ca is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwentynine)