...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br> if f(x) is a polynomial function such that f(x)f(1/x)= f(x)+f(1/x) and f(2) = 33 then f(x)=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ffourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ffourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ffourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirteen)