...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br> If f(x)={'\u221c'}(25-x{'\u2074'}) for 0{'\u003c'}x{'\u003c'} {'\u221a'}5 then f(f(1/2)) =
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwentytwo)