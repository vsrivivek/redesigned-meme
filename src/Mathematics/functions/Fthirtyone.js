...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> Read the given statements and select the correct option<br></br>
Statement-I: Every function must be either even or odd function<br></br>
Statement-II: The function f(x)= log(x+ {'\u221a'}x{'\u00b2'}+1) is an odd function<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtyone)