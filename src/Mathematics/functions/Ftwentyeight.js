...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br>   The range of the function f(x)= (sin{'\u03c0'}[x{'\u00b2'}-1])/(x{'\u2074'}+1)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwentyteight)