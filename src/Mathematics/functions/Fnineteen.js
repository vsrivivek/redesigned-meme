...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br>If f from R into R defined by f(x)= x{'\u00b3'}-1, then f{'\u207b'}{'\u00b9'}{`{2,0,7}`}=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Feighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fnineteen)