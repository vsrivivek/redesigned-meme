...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> f(x)= cos[{'\u03c0'}{'\u00b2'}]x + sin[-{'\u03c0'}{'\u00b2'}]x where [x] is a step function, then f({'\u03c0'}/6)=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Feleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwelve)