...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>The domain of f(x)=(x{'\u00b2'}-2x+3)/(x{'\u00b2'}+x-6)  is 
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/Ftwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (Fone)