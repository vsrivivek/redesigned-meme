...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>  if f : R{'\u2192'}R is defined by f(x)= x{'\u00b2'}+3x+2, then f(x-1)=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Feight)