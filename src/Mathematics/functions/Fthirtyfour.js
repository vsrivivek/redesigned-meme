...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>  If f(x)= x{'\u00b2'} for x{'\u003c'}0, f(x)=x for 0{'\u003c'}x{'\u003c'}1, f(x)=1/x for x{'\u003e'}1 then the domain of f(x) is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtyfour)