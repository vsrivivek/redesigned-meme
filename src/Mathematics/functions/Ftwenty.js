...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>If f(x)= {'\u221a'}x{'\u00b3'}-1 and g(x) = {'\u221b'}x{'\u00b2'}+1 then fog(x)
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwenty)