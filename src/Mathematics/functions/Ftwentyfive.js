...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>The domain of (2<sup>x</sup>+2<sup>-x</sup>)/(2<sup>x</sup>-2<sup>-x</sup>) is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Ftwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Ftwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Ftwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (Ftwentyfive)