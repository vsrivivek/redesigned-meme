...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br>Set A and B be finite sets and P<sub>A</sub> and P<sub>B</sub> respectively denote their power sets. If P<sub>B</sub> has 112 elements more than those in P<sub>A</sub> then the number of functions from A to B which are injective is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/Fthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/Fthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/Fthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (Fthirtyseven)