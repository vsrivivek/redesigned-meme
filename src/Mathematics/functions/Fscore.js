...
const button=<button style={wStyle1} onClick={()=>navigate('/Fsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (Fscore)