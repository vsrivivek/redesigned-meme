...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <p> <i>Question No.21</i><br></br> If <b>i</b>+2<b>j</b>+3<b>k</b> , 3<b>i</b>+2<b>j</b>+<b>k</b> are sides of a parallelogram, then a unit vector parallel to one of the daigonals of the parallelogram is
      <br></br><b>[EAMCET 04]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentyOne)