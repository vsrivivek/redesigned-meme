...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <p> <i>Question No.31</i><br></br> If M is the foot of perpendicular drawn from P(1,2,-1) to the plane passing through the point  A(3,2,-1) and perpendicular to the vector 4<b>i</b>+7<b>j</b>-4<b>k</b>, then the length of PM, in proper units is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtyone)