...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <p><i>Question No.18</i><br></br> The vector a<b>i</b>+b<b>j</b>+c<b>k</b> is a bisector of the angle between the vectors <b>i</b>+<b>j</b> and <b>j</b>+<b>k</b> if
      <br></br><b>[EAMCET 95]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVeighteen)