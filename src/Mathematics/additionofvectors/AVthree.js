...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    {/* <h5>Question No.3 </h5> */}
    <p> <i>Question No.3</i><br></br>If a,b and c are non-coplanar  vectors and d is such that d=(1/x)(a+b+c) and a=(1/y)(b+c+d) where X and y are non-zero real numbers, then   (1/ xy)(a+b+c+d)=
<br></br><b>[EAMCET 14]</b>
 </p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthree)