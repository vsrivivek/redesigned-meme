...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <form>
      {/* <h5>Question No.32 </h5> */}
    <p><i>Question No.32</i><br></br> The line passing through the point 2<b>a</b>+<b>a</b> and parallel to the vector <b>b</b>-<b>c</b> and the plane passing through the point <b>a</b> and parallel to the vectors <b>b</b>+<b>c</b> and <b>a</b>+2<b>b</b>-<b>c</b> intersect at P. The position vector of P is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtytwo)