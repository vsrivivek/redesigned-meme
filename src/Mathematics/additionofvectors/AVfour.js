...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    {/* <h5>Question No.4 </h5> */}
    <p><i>Question No.4</i><br></br>If the position vectors of A and B are 3i-2j+k and 2i+4j-3k then |AB|=?
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/AVfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVfour)