...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
      {/* <h5>Question No.1 </h5> */}
      <p><i>Question No.1</i><br></br>If the points whose position vectors are 2i+j+k,6i-j+2k and 4i-5j+pk are collinear, then the value of p is<br></br>
<b>[EAMCET 07]</b>
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/AVtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (AVone)