...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>If the vector <b>a</b>=2<b>a</b>i+3<b>j</b>+6<b>k</b> and  <b>b</b> are collinear and │<b>b</b>│=21, then <b>b</b>=<br>
    </br><b>[EAMCET 05]</b>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVeight)