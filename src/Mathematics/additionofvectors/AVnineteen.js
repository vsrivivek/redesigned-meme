...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <p><i>Question No.19</i><br></br>  For three vectors <b>p</b>,<b>q</b> and <b>r</b>, if <b>r</b>=3<b>p</b>+4<b>q</b> and 2<b>r</b>=<b>p</b>-3<b>q</b>, then
    <br></br><b>[EAMCET 16AP]</b>
      ...
      <div>
        ...
        /> |<b>r</b>|{'\u003c'}2|<b>q</b>| and <b>r</b>,<b>q</b> have same direction
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> |<b>r</b>|{'\u003e'}2|<b>q</b>| and <b>r</b>,<b>q</b> have opposite direction
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVnineteen)