...
// import AVtimer from '../../components/AVtimer ';
import QuestionNumbers from './QuestionNumbers';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    {/* <h5>Question No.39</h5> */}
    <p><i>Question No.39</i><br></br> If {'\u03b1'},{'\u03b2'},{'\u03b3'} are distinct real numbers and {'\u03b1'}+{'\u03b2'}+{'\u03b3'}{'\u2260'}0, then the points with position vectors {'\u03b1'}<b>i</b>+{'\u03b2'}<b>j</b>+{'\u03b3'}<b>k</b>,{'\u03b2'}<b>i</b>+{'\u03b3'}<b>j</b>+{'\u03b1'}<b>k</b>, {'\u03b3'}<b>i</b>+{'\u03b1'}<b>j</b>+{'\u03b2'}<b>k</b> are
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtynine)