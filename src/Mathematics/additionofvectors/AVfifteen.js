...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <p> <i>Question No.15</i><br></br>  The position vector of a point lying on the line joining the points whose position vectors are <b>i</b>+<b>j</b>+<b>k</b> and <b>i</b>-<b>j</b>+<b>k</b> is
<br></br><b>[EAMCET 06]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('AVfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVfifteen)