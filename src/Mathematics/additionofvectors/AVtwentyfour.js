...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentythree()
    ...
    <p>  <i>Question No.24</i><br></br>if <b>a</b>,<b>b</b>,<b>c</b> are three noncollinear points then <b>r</b>=(1-p-q)<b>a</b>+p<b>b</b>+q<b>c</b> represents
<br></br><b>[EAMCET 03,88]</b>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentyfour)