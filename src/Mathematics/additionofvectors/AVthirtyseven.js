...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <p><i>Question No.37</i><br></br>A line L passes through the points <b>i</b>+2<b>j</b>+<b>k</b> and -2<b>i</b>+3<b>k</b>. A plane P passes through the origin and the points 4<b>k</b>,2<b>i</b>+<b>j</b>. The point where the line L meets the plane P is
    <br></br><b>[EAMCET 18TS]</b>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtyseven)