...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <div className={props.header} style={bStyle}>
     <h1 style={hStyle}> <img  style={logoStyle} src={Logo} alt="Logo" /></h1> 
        ...
        {/* <div className={props.title}>
          <h3>Morphology Of Flowering Plants</h3>
        </div> */}
    ...
    <p>  <i>Question No.20</i><br></br>Consider the following points A,B,C,D with position vectors 7<b>i</b>-4<b>j</b>+7<b>k</b>, <b>i</b>i-6<b>j</b>+10<b>k</b>, -<b>i</b>-3<b>j</b>+4<b>k</b>,5<b>i</b>-<b>j</b>+<b>k</b> respectively. Then ABCD is a 
<br></br><b>[AIEEE 03]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwenty)