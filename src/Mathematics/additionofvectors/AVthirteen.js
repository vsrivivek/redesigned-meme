...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <p> <i>Question No.13</i><br></br> The ratio in which <b>i</b>+2<b>j</b>+3<b>k</b> divides the join of  -2<b>i</b>+3<b>j</b>+5<b>k</b> and 7<b>i</b>-<b>k</b> is
<br></br><b>[EAMCET 97,07]</b>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirteen)