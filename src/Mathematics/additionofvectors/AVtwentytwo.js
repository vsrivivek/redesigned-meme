...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <p> <i>Question No.22</i><br></br> The vector equation of the plane passing through the points (1,-2,-3) and parallel to the vectors (2,-1,3) (2,3,-6) is
      <br></br><b>[EAMCET 91]</b>
</p>
      <div>
        <input
        ...
        /> <b>r</b>= (<b>i</b>-2<b>j</b>-3<b>k</b>)+s(2<b>i</b>-<b>j</b>+3<b>k</b>)+t(2<b>i</b>+3<b>j</b>-6<b>k</b>)
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> <b>r</b>= (1-s-t)(<b>i</b>-2<b>j</b>-3<b>k</b>)+s(2<b>i</b>-<b>j</b>+3<b>k</b>)+t(2<b>i</b>+3<b>j</b>-6<b>k</b>)
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> <b>r</b>= (<b>i</b>-2<b>j</b>-3<b>k</b>)+s(4<b>j</b>-9<b>k</b>)
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> <b>r</b>= (4<b>j</b>-9<b>k</b>)+s(<b>i</b>-2<b>j</b>-3<b>k</b>)
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentytwo)