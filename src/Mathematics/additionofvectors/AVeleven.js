...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    <p><i>Question No.11</i><br></br> The vectors  2<b>i</b>-3<b>j</b>+<b>k</b>,  <b>i</b>-2<b>j</b>+3<b>k</b>,  3<b>i</b>+<b>j</b>-2<b>k</b>
<br></br><b>[EAMCET 16TS]</b>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVeleven)