...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <p><i>Question No.40</i><br></br> if <b>a</b>,<b>b</b>,<b>c</b> are three non-collinear points and k<b>a</b>+2<b>b</b>+3<b>c</b> is a point in the pane of <b>a</b>,<b>b</b>,<b>c</b> then k=
    <br></br><b>[EAMCET 19TS]</b>
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVforty)