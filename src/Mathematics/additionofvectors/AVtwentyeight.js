...
<div className={props.header} style={bStyle}>
    ...
    <p><i>Question No.28</i><br></br>   Observe the following statements<br></br>
    ...
    R: Any three coplanar vectors are linearly dependant<br></br>
     Then which of the following is true<br></br><b>[EAMCET 05]</b>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentyteight)