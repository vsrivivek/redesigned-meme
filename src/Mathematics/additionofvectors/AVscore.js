...
const button=<button style={wStyle1} onClick={()=>navigate('/AVsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (AVscore)