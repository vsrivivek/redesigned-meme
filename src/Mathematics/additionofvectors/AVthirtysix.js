...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <p>   <i>Question No.36</i><br></br> The position vectors of three points A,B, and c are (1,3,x),(3,5,8) and (y,-1,-6) respectively. If A,B and C are collinear, then (x,y)=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtysix)