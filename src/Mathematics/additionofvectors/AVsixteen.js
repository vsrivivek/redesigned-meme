...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <p><i>Question No.16</i><br></br>If C is the midpoint of AB and P is any point outside AB, then
      <br></br><b>[AIEEE 05]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVsixteen)