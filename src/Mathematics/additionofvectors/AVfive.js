...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    {/* <h5>Question No.5 </h5> */}
    <p> <i>Question No.5</i><br></br> If <b>a</b>=3<b>i</b>-2<b>j</b>+<b>k</b>,<b>b</b>=2<b>i</b>-4<b>j</b>-3<b>k</b>,<b>c</b>=-<b>i</b>+2<b>j</b>+2<b>k</b> then <b>a</b>+<b>b</b>+<b>c</b>=
<br></br><b>[AIEEE 02]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVfive)