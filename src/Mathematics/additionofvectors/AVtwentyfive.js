...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <p><i>Question No.25</i><br></br>P,Q,R,S are four points with the position vectors 3<b>i</b>-4<b>j</b>+5<b>k</b>,4<b>k</b>,-4<b>i</b>+5<b>j</b>+<b>k</b>,-3<b>i</b>+4<b>j</b>+3<b>k</b> respectively. Then the line PQ meets the line RS at the point
<br></br><b>[EAMCET 13]</b>
</p>
      <div>
        <input
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentyfive)