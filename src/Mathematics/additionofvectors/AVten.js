...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <p><i>Question No.10</i><br></br>The  points having position vectors 2<b>i</b>+3<b>j</b>+4<b>k</b>,3<b>i</b>+4<b>j</b>+2<b>k</b>,4<b>i</b>+2<b>j</b>+3<b>k</b> are
<br></br><b>[EAMCET 98]</b>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVten)