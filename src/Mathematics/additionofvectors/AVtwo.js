...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Let a,b and c be three nonzero vectors, no two  of which are collinear. If the vector a+2b is collinear with c, and b+3c is collinear with a, then a+2b+6c=
<br></br><b>[AIEEE 04]</b></p>
    {/* <p>Let a,b and c be three nonzero vectors, no two  of which are collinear. If the vector a+2b is collinear with c, and b+3c is collinear with a, then a+2b+6c=
<br></br><b>[AIEEE 04]</b> */}
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwo)