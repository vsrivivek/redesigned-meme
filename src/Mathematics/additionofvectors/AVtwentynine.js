...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <p> <i>Question No.29</i><br></br>  The points with position vectors <b>a</b>+<b>b</b>, <b>a</b>-<b>b</b> and <b>a</b>+k<b>b</b> are collinear 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVtwentynine)