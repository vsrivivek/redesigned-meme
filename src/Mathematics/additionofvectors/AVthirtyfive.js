...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <p><i>Question No.35</i><br></br>If the position vectors of A,B,C,D are <b>i</b>+2<b>j</b>+2<b>k</b>,2<b>i</b>-<b>j</b>,<b>i</b>+<b>j</b>+3<b>k</b> and 4<b>j</b>+5<b>k</b> respectively, then the quadrilateral ABCD is a 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AVthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AVthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AVthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AVthirtyfive)