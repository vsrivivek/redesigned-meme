...
const button=<button style={wStyle1} onClick={()=>navigate('/PTsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (PTscore)