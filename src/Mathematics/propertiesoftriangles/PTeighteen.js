...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br> In {'\u25b3'}ABC, [sinA(a-bcosC)]/[sinC(c-acosB)]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTeighteen)