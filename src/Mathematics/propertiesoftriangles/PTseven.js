...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> If ABC is a triangle then one root of x<sup>2</sup>-2bxcosA+b<sup>2</sup>-a<sup>2</sup>=0 is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTseven)