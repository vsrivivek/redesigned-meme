...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>  In an equilateral triangle r:R:r<sub>1</sub> is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirtyeight)