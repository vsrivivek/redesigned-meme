...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br>   In {'\u25b3'}ABC, if tan[(C-A)/2]=kcot(B/2), then k=</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwentyteight)