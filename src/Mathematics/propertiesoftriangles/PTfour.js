...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>In {'\u25b3'}ABC, if sin<sup>2</sup>A+sin<sup>2</sup>B=sin<sup>2</sup>C,then C=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTfour)