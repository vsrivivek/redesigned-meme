...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> In {'\u25b3'}ABC, (1/r-1/r<sub>1</sub>)(1/r-1/r<sub>2</sub>)(1/r-1/r<sub>3</sub>)=
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTforty)