...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>If {'\u0394'}= a<sup>2</sup>-(b-c)<sup>2</sup> is the area of the triangle ABC, then tan A=
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwo)