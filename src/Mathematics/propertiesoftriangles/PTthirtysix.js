...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br>  If the sides of a triangle are 13,14,15 then the radius of the incircle is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirtysix)