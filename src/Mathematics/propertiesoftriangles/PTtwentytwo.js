...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br> Two sides of a triangle are given by the roots of the equation x<sup>2</sup>-5x+6=0 and the angle between the sides is π/3. Then the perimeter of the triangle is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwentytwo)