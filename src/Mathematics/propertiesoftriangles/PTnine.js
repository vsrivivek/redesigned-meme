...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br> If A,B,C are angles of an acute angled triangle then the least value of tanA tanB tanC=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTnine)