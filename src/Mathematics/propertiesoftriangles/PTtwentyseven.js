...
// import PTtimer from '../../components/PTtimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>In {'\u25b3'}ABC, if b=(c+a)cos{'\u03b8'}, then sin{'\u03b8'}=</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> [2{'\u221abc'}/(b-c)]sin(A/2)      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwentyseven)