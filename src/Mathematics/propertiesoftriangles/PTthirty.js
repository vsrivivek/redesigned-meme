...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br>In {'\u25b3'}ABC, tan(A/2)=5/6, and tan(C/2)=2/5 then</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirty)