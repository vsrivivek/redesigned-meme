...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br> In {'\u25b3'}ABC, {'\u03a3'}a<sup>2</sup>(cos<sup>2</sup>B-cos<sup>2</sup>C)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirteen)