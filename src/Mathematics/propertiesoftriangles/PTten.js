...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>In a right angled triangle {'\u25b3'}ABC, sin<sup>2</sup>A+sin<sup>2</sup>B+sin<sup>2</sup>C=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTten)