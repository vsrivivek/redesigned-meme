...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br> In {'\u25b3'}ABC, C=90<sup>o</sup>. Then [(a<sup>2</sup>-b<sup>2</sup>)/(a<sup>2</sup>+b<sup>2</sup>)]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTfourteen)