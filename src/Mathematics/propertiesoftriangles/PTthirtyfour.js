...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>In {'\u25b3'}ABC, (s-a)/11=(s-b)/12=(s-c)/13, then tan<sup>2</sup>(A/2)=</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirtyfour)