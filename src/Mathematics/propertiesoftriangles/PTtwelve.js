...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> In a triangle ABC, if a is the arithmetic mean and b,c (b{'\u2260'}c) are the two geometric means between any two positive real numbers then <br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwelve)