...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>In {'\u25b3'}ABC, if a<sup>2</sup>+b<sup>2</sup>+c<sup>2</sup>=8R<sup>2</sup>, then the triangle is
       </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTfive)