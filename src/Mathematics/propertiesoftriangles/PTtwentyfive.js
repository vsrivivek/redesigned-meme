...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>In {'\u25b3'}ABC, if cosA+2cosB+cosC=2, then the sides of the triangle are in </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwentyfive)