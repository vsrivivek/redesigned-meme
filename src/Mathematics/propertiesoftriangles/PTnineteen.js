...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br> In {'\u25b3'}ABC, (b+c-a)tan(A/2)=
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTnineteen)