...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br> In {'\u25b3'}ABC, {'\u03a3'}[(sin<sup>2</sup>A+sinA+1)/sinA] is always greater than
</p> 
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTeight)