...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>  In {'\u25b3'}ABC, {'\u03a3'}(b+c)tan(A/2)tan[(B-C)/2]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTtwenty)