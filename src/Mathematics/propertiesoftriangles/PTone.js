...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>In {'\u25b3'}ABC, If a={'\u221a'}3+1, B= 30<sup>o</sup>, C=45<sup>o</sup>, then c=
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/PTtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (PTone)