...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br> If the sides of a triangle are in the ratio of x : y : {'\u221a'}(x<sup>2</sup>+xy+x<sup>2</sup>), then the greatest angle is
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthree)