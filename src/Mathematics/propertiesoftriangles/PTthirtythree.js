...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> In {'\u25b3'}ABC,If (sinA/4)=(sinB/5)=(sinC/6) then the value of cosA+cosB+cosC= </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTthirtythree)