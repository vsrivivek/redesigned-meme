...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>The radius of the circumcircle of an isosceles triangle PQR is equal to PQ(=PR), then the angle P is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTsix)