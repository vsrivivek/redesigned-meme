...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.17</i><br></br>In {'\u25b3'}ABC, {'\u03a3'}a<sup>3</sup> sin(B-C)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PTeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PTeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PTeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PTsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PTseventeen)