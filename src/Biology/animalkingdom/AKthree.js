...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
    {/* <h5>Question No.3 </h5> */}
    <p><i>Question No.3</i><br></br>dentify the animal which has ladder like nervous system
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthree)