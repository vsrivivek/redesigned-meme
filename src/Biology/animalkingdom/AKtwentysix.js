...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.26</i><br></br>  In some chordates, the notochord is modified as the vertebral column. Such animals are called vertebrates. Which one of the following statements is correct?
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Chordates are not vertebrates but all vertebrates are chordates 
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentysix)
