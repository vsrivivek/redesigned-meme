...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
    {/* <h5>Question No.4 </h5> */}
    <p><i>Question No.4</i><br></br> In most simple type of canal system of porifera, which of the following ways exhibit water ways?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKfour)