...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.21</i><br></br>  Which of the following is/are examples of subphylum Urochordata?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentyOne)