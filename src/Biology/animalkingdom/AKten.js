...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.10</i><br></br>Read the following characters<br></br>
(i) Extracellular and intracellular digestion<br></br>
...
The characters given above are shown by
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKten)