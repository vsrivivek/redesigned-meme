...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.25</i><br></br>Which one of the following statements is incorrect about the occurence of notochord
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentyfive)