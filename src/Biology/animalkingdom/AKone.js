...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
      {/* <h5>Question No.1 </h5> */}
      <p><i>Question No.1</i><br></br> Which of the following statements is incorrect regarding bilateral symmetry
      ...
      <div>
        <input
          ...
          checked={option === 'b'}
          onClick={handleChange}
        /> The oraganisms that show bilateral symmetry have paired body organs that occur on the two sides of a central axis
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/AKtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (AKone)