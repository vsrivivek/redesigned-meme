...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
    {/* <h5>Question No.2 </h5> */}
    <p><i>Question No.2</i><br></br>Diploblastic and triploblastic are terms that describe
      ...
      <div>
        <input
          ...
          checked={optionone=== 'd'}
          onClick={handleChange}
        /> the number of cell types during embryonic development
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwo)