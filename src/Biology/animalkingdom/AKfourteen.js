...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.14</i><br></br>    What is common between earthworm and periplaneta
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKfourteen)