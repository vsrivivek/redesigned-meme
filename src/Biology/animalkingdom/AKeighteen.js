...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.18</i><br></br>  Which one of the following is a matching set of a phylum and its three examples?
      ...
      <div>
        ...
        /> Porifera- <i>Spongilla, Euplectella, Pennatula</i>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Cnidaria-<i>Dentalium, Physalia, Aurelia</i>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Platyhelminthes- <i>Planaria, Schistosoma, Enterobius</i>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Mollusca- <i>Loligo, Teredo, Octopusps</i>
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKeighteen)