...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.19</i><br></br>  You have discovered an animal having chacaters like, triploblastic, bilteral symmetry,  coelomate, chitinous exoskeleton, head, thorax and abdomen as body parts and jointed appendages. You should place the animal under
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKnineteen)