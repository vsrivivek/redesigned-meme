...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.30</i><br></br> Which of the following group is formed of only the hermaphrodite organisms
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirty)