...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.29</i><br></br> Which of the following is/are not the characteristic of the class Osteichthyes<br></br>
...
(iv) Many of them viviparous<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentynine)