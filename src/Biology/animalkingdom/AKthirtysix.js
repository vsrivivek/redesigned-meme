...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.36</i><br></br>   Read the following.<br></br>
(i) Body is covered by dry and cornified skin, epidermal scales or scutes<br></br>
(ii) They haveno external ear<br></br>
(iii) Crawling, creeping habit<br></br>
(iv) 3 Chambered heart<br></br>


The characterisitcs given above are associated with
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirtysix)