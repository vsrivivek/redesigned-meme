...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
      {/* <h5>Question No.9</h5> */}
    <p> <i>Question No.9</i><br></br> Which of the following have porous body and diploblastic?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKnine)