...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.32</i><br></br> Read the given statements and select the correct option<br></br>
...
Statement-II: Amphibians are poikilothermic animals and cannot regulate body temparature<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirtytwo)