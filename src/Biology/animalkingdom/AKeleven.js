...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.11</i><br></br> Given below are three statements regarding aschelminthes<br></br>
...
Select the coorect option that has both the correct statements
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKeleven)