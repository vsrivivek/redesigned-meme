...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
      {/* <h5>Question No.6</h5> */}
    <p><i>Question No.6</i><br></br>Select the incorrect characteristic regarding sponges
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKsix)