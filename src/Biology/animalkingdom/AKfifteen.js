...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.15</i><br></br> Which of the following are examples of phylum arthropoda
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Clam worm, apple snail, honeybee
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKfifteen)