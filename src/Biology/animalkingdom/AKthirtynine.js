...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.39</i><br></br> Which of the following classes is incorrectly matched with its general characters?
      ...
      <div>
        ...
        /> Cyclostomata: Lack jaws and pairs fins and body is covered with placoid scales
            <div>
        <input
          type="radio"
          value="b"
          ...
          onClick={handleChange}
        /> Osteichthyes: Fout pairs of gills are covered with an operculum and skin is covered with cycloid scales
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        />  Reptilia: Tympanum represents ear and fertilisation is internal
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Aves: Endoskeleton is fully ossified and long bones are hollow with air cavities called as pneumatic bones
        </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirtynine)