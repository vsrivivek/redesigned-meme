...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
      {/* <h5>Question No.7</h5> */}
    <p> <i>Question No.7</i><br></br> Which of the following statements is correct for sponges without exception?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKseven)