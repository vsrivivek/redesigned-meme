...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.20</i><br></br>  Which of the following statements are incorrect?<br></br>
...
(v) Ctenophorans diploblastic<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwenty)