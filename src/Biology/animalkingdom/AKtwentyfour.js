...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.24</i><br></br>  Read the given statements and selecct the correct option<br></br>
...
Statement-II: In cephalochordates, notochord extends from head to tail.<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentyfour)