...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.22</i><br></br> Crocodile and penguine are similar to whale and dogfish in which of the following features
      ...
      <div>
        ...
        /> Possess a solid stranded central nervous system
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentytwo)