...
return (
    ...
    <h1 style ={hStyle}> <img  style={logoStyle} src={Logo} alt="Logo" /></h1> 
          ...
          <DYtimer /></div><br></br> */}
          <div><h2 style ={hstyle}>Dear {props.name}, time is up!!!Click the button below to go to the score page</h2></div>
<div style={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/AKscore'))}>Score Page</button> </div>
</div>
{/* <p>{props.score}</p> */}
</div>
  )
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (AKtimeup)