...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <form>
    {/* <h5>Question No.5 </h5> */}
    <p> <i>Question No.5</i><br></br> Which of the following is not a characteristic feature of sponges?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKfive)