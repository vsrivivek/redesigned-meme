...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.28</i><br></br>   To which classes do the following animals belong<br></br>
A-Petromyzon,B-Scoliodon,C-Pristis
      ...
      <div>
        ...
        /> A-Cyclostoamata, B-Chondrichthyes,C-Chondrichtyes
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> A-Osteichthyes, B-Chondrichthyes,C-Chondrichtyes
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> A-Osteichthyes, B-Chondrichthyes,C-Osteichthyes
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentyteight)