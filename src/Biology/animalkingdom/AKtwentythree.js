...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.23</i><br></br>  Read the given statements and selecct the correct option<br></br>
...
Statement-II: Urochordates and cephalochordates are a connecting link between the invertebrates and chordates<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentythree)