...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.12</i><br></br> In which of the following, segmentation in the body is first observed
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwelve)