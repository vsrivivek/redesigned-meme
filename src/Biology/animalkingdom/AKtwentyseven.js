...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p> <i>Question No.27</i><br></br>  A common chacateristic of all vertebrates without exception is 
      ...
      <div>
        ...
        /> the division of body inot head,neck,trunk and tail.
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKtwentyseven)