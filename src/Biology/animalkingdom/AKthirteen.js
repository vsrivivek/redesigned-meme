...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p><i>Question No.13</i><br></br>  Read the given statements and selecct the correct option<br></br>
...
Statement-II: Insect blood has no role in O2 transport<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirteen)