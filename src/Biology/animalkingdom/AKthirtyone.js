...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <tr>  
    ...
    <p>  <i>Question No.31</i><br></br>Which of the following statements is/are correct or incoorect regarding Class Amphibia<br></br>
...
(v) Has eyelids<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/AKthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/AKthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/AKthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (AKthirtyone)