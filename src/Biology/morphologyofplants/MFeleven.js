...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.11</i><br></br> In Bougainvilea, weak stems rise up a support by clinging to it with the help of curved thorns, such plants are called as
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFeleven)