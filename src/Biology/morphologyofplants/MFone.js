...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.1 </h5> */}
      <p> <i>Question No.1</i><br></br> Edible roots are found in
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/MFtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (MFone)