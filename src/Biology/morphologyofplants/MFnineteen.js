...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.19</i><br></br> A simple leaf can be differeniated from the pinnae of a compound leaf on the basis of presence or absense of 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFnineteen)