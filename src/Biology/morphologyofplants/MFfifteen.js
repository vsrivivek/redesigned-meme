...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.15</i><br></br>  In some____________________, the leaf base may become swollen and is called as_____________________
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFfifteen)