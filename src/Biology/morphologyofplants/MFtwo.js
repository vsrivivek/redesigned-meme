...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.2 </h5> */}
    <p><i>Question No.2</i><br></br>Select the group of plants that possess stilt roots
      ...
      <div>
        <input
          ...
          checked={optionone === 'b'}
          onClick={handleChange}
        /> Pandanus odoratissimus, Ficus benghalensis
      ...
      <div>
        <input
          ...
          checked={optionone === 'c'}
          onClick={handleChange}
        /> Rhizophora mangle, Hedera helix
      ...
      <div>
        <input
          ...
          checked={optionone=== 'd'}
          onClick={handleChange}
        /> Ficus benghalensis, Pisum sativum
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/MFthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (MFtwo)