...
const button=<button style={wStyle1} onClick={()=>navigate('/MFsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (MFscore)