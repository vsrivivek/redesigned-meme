...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.40</i><br></br>In albuminous seeds, food is stored in________________ and in exabalbuminous seeds, food is stored in ________________.
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/MFthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFforty)