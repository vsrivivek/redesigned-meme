...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.21</i><br></br>  In ____________________ phyllotaxy, a pair of leaves arise at each node and lie opposite to each others as in __________________ plant
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFtwentyOne)