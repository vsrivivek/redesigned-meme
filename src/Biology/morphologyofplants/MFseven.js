...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.7</h5> */}
    <p> <i>Question No.7</i><br></br> Read the following statements and select the correct ones<br></br>
...
(iv) Hydrophytes usually possess a well developed root system<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFseven)