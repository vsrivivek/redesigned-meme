...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.5 </h5> */}
    <p><i>Question No.5</i><br></br>  Unbranched, erect, cylindrical stout axis with distinct nodes and internodes and with jointed appearence is called as 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFfive)