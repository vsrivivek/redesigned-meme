...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.9</h5> */}
    <p><i>Question No.9</i><br></br>  Which of the following is not an example of corm
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFnine)