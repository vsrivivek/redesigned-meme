...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.20</i><br></br> In spiral phyllotaxy, the number of leaves at each node is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/MFtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/MFtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/MFtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/MFnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (MFtwenty)