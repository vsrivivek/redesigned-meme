...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> {props.BHealthanddiseasefortyone}</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/DYforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYthirtyNine)