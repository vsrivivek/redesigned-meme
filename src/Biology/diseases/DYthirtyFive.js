...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> Which of the following are vector born diseases?  <br></br>A) Malaria <br></br>B) Dengue fever	<br></br>C) Amoebiasis<br></br> D) Filariasis	<br></br>E) Typhoid <br></br> F) Chikun gunya, <br></br> The correct combination is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/DYthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYthirtyFive)