...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p>  {props.BHealthanddiseaseThirtythree}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseThirtythreeA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtythreeB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtythreeC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtythreeD}
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/DYthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYthirtyOne)