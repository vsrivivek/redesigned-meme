...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p>Which of the following microbe causes pneumonia in man <br></br>Assertion : Entamoeba hystolytica causes amoebic dysentery in man <br></br>Reason : House fly acts as biological vector which serves to transmit the parasite from one person to another</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/DYtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYtwentyTwo)