...
import { reseightUpdate } from '../../redux/cake/cakeAction';
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
       ...
       <p><i>Question No.1</i><br></br>{props.BHealthanddiseaseOne}</p> 
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/DYtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYtwo'))}>Save & Next</button>
        </div> </div>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYone)