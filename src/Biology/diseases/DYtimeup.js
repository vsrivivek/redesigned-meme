...
return (
    ...
    <div>
          ...
          <DYtimer /></div><br></br> */}
          <div><h2 style ={hstyle}>Dear {props.name}, Time is up!!! click the button below to got score page.<br></br></h2></div>
<div style ={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/DYscore'))}>Score Page</button></div>
</div>
</div>
  )
}
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (DYtimeup)