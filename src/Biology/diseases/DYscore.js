...
const button=<button style={wStyle1} onClick={()=>navigate('/DYsummary')}>Summary</button>;
...
<h2 style={sStyle}>Exam Summary</h2>
  ...
  <tr  style={mystyle}>
    ...
    <h3 style={hstyle}> Dear <b>{props.name}</b>, your Test is submitted succesfully!!!! Please click the button to get your score.</h3>
    <div ><button style ={wStyle1} onClick={()=>(clickHandler)(setbtn)} disabled={buttonState}>Get Score</button></div>
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (DYscore)