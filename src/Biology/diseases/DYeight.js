...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      <h5>Question No.8</h5>
    <p>  Diseases are broadly grouped into infectious and non-infectious deseases. In the list given below identify the infectious diseases<br></br>i.Cancer <br></br>ii.Influenza<br></br> iii.Allergy<br></br>	iv.Small pox</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>  
        <button onClick={()=>(clickHanlderNext)(navigate('/DYnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYseven'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (DYeight)