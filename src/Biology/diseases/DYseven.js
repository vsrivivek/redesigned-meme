...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      <h5>Question No.7</h5>
    <p>  {props.BHealthanddiseaseEight}</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          checked={optionsix === 'd'}
          onClick={handleChange}
        /> {props.BHealthanddiseaseEightD}
      </div>   
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/DYeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/DYeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/DYeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/DYsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (DYseven)