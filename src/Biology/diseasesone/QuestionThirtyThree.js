...
function QuestionThirtyThree(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <p> {props.BHealthanddiseaseThirtyfive}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseThirtyfiveA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfiveB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfiveC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfiveD}
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/thirtfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/thirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionThirtyThree)