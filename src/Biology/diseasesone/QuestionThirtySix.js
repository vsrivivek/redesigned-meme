...
function QuestionThirtySix(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <p>  {props.BHealthanddiseaseThirtyeight}</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/thirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/thirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionThirtySix)