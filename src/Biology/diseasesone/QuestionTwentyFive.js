...
function QuestionTwentyFive(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <p>  {props.BHealthanddiseaseTwentyseven}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseTwentysevenA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentysevenB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentysevenC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentysevenD}
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/twentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/twentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/twentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/twentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionTwentyFive)