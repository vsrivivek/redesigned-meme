...
function QuestionThirtyTwo(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <p> {props.BHealthanddiseaseThirtyfour}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseThirtyfourA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfourB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfourC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseThirtyfourD}
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/thirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/thirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/thirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionThirtyTwo)