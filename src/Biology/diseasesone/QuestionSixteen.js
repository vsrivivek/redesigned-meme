...
function QuestionSixteen(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <p>  {props.BHealthanddiseaseSeventeen}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseSeventeenA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseSeventeenB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseSeventeenC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseSeventeenD}
      </div>       
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/seventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/seventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/seventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/fifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionSixteen)