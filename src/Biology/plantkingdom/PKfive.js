...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.5 </h5> */}
    <p> <i>Question No.5</i><br></br> Read the given statements about algae and select the correct option<br></br>
...
(iv) chlamydomonous, Volvox and ulothrix are the mutlicellular algae<br></br>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> only statements(ii) & (iii) are true
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKfive)