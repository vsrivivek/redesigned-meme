...
<div style={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/PKscore'))}>Confirm</button>    <button style={bstyle1} onClick={()=>navigate('/PKone')}>Cancel</button></div>
</div>
<p>{props.score}</p>
</div>
  )
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (PKconfirm)