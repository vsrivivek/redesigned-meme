...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.3 </h5> */}
    <p><i>Question No.3</i><br></br>A system of classification in which a large number of traits are considered is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKthree)