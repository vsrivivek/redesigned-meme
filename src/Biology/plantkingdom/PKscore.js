...
const button=<button style={wStyle1} onClick={()=>navigate('/PKsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (PKscore)