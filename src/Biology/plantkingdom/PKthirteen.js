...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p>  <i>Question No.13</i><br></br>Common example of red algae is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKthirteen)