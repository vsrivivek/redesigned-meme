...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.12</i><br></br> Photosynthetic pigments of Rhodophyceae(red agae) are
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwelve)