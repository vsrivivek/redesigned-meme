...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.35</i><br></br> Read the given statements and select the incorrect ones.<br></br>
...
(iv) in Cycas, male cones and megasporophylls are borne on the same trees<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKthirtyfive)