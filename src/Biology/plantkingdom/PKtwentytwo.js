...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.22</i><br></br> The spread of living pteridophytes is limited and is restricted to narrow geographical region because 
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> there is requirement of water for fertilisation
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> there is absence of stomata in leaf and absence of vascular tissue
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwentytwo)