...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.39</i><br></br> ______________classification systems were based on evolutionary relationships between various organisms
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKthirtynine)