...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.20</i><br></br> Which of the following statements is incorrect?
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Spagnum is used as packing material for transportation of living material      
      </div> 
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwenty)