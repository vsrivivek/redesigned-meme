...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.8</h5> */}
    <p> <i>Question No.8</i><br></br> Seaweeds are a source of 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKeight)