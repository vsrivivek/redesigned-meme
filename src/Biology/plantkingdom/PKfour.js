...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.4 </h5> */}
    <p> <i>Question No.4</i><br></br>  Which of the following are included under Tracheophyta i.e, vascular plants?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKfour)