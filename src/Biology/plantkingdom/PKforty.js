...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No. 40</i><br></br> Gymnosperms do not bear fruits because they do not have
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKforty)