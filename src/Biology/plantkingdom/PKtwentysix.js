...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.26</i><br></br>  Coralloid roots of __________________ have symbiotic association with Nitrogen fixing cyanobacteria
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwentysix)
