...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.9</h5> */}
    <p><i>Question No.9</i><br></br>  In most green algae, pyrenoids, the storage bodies, are located in
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKnine)