...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.23</i><br></br> Heterosporous pteridophytes show certain characteristics, which are precursor to the 'seed habit' in gymnosperms. One of such characteristics is 
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> external water required for fertilisation
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> development of embryo inside the female gametophy
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwentythree)