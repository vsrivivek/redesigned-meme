...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.38</i><br></br> Plant classification as proposed by Carlous Linnaeus was artificial because it was based on 
      ...
      <div>
        ...
        /> only few morphological characters
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> physiological and morpohological characters
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKthirtyeight)