...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.6</h5> */}
    <p><i>Question No.6</i><br></br>Fusion between morphologically alike gametes is referred to as</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKsix)