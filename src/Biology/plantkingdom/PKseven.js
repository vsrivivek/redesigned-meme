...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.7</h5> */}
    <p> <i>Question No.7</i><br></br> Atleast half of the total CO<sub>2</sub> fixation on earth is acrried out through photosynthesis by 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKseven)