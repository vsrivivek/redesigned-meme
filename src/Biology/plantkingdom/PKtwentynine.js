...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.29</i><br></br> Which of the following structures are haploid in gymnosperms
      ...
      <div>
        ...
        /> Pollen grain, mega spore, embryo
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Pollen grain, mega spore, endosperm
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/PKthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/PKtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (PKtwentynine)