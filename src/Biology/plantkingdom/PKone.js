...
// import PKimer from '../../components/Timer ';
...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.1 </h5> */}
      <p> <i>Question No.1</i><br></br>Artificial systems of classification were based on 
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/PKtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/PKtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/PKtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (PKone)