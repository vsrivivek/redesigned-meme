...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.9</h5> */}
    <p> <i>Question No.9</i><br></br>  Select the correct statement regarding heterocysts</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> They are present in some filamentous cyanobacteria such as Nostoc and Anabena
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> These cells are specialised to perform Nitrogen fixation
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> They contain enzyme nitrogenase
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCnine)