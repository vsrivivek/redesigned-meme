...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.20</i><br></br> Diatameceous earth is used for all except
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwenty)