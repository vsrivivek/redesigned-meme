...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.6</h5> */}
    <p><i>Question No.6</i><br></br>   Cyanobacteria are classified into which of the following kingdoms
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCsix)