...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.7</h5> */}
    <p><i>Question No.7</i><br></br>   Photosynthetic pigments of cyanobacteria (blue green algae) include</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCseven)