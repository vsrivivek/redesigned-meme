...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.36</i><br></br>  Which of the following statements regarding viruses are correct<br></br>
...
(III). Genetic material is either DNA or RNA, but never both<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthirtysix)