...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.2 </h5> */}
    <p><i>Question No.2</i><br></br>Which of the following characters served as the criteria for five kingdom system of classification as used by R.H Whittaker</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> Cell structure and thallus organisation
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwo)