...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.25</i><br></br> The multi nucleate slimy mass of protoplasm which forms the body of slime moulds is called
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwentyfive)