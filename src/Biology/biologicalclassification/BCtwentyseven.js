...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.27</i><br></br>  The sporozoa are all internal _________________that typically have an infective cyst stage in their life cycle. An example of sporozoa is the gunus__________________,which causes malaria.
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwentyseven)