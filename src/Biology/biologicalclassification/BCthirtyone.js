...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <p> <i>Question No.31</i><br></br> Common character found in ascomycetes member, deuteromycetes member and basidiomycetes member is 
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> meiosis takes place in fruting bodies
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthirtyone)