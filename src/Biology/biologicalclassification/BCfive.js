...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.5 </h5> */}
    <p><i>Question No.5</i><br></br>   Which of the following statements is incorrect regarding the structure of a typical bacterial cell?
</p>
      <div>
        <input
          type="radio"
        ...
        /> Cell possess naked circular DNA which is folded to form nucleoid
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Cells are sorrounded by a peptidoglycon cell wall and mucilaginous sheath
      </div> 
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Rhibosomes in these cells are 70S in nature
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCfive)