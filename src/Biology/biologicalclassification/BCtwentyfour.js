...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.24</i><br></br>  Read the following statements and select the correct option<br></br>
 ...
 Statement 2: Euglena cannot be classified on the basis of two kingdom system of classification<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwentyfour)