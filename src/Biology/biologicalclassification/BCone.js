...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    {/* <p style= {pStyle}>Name of the Test: Biological Classification</p> */}
    ...
    <form>
      {/* <h5>Question No.1 </h5> */}
      <p><i>Question No.1</i><br></br>  The classification system proposed by Linnaeus was a ____________________ kingdom system of classificaction
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/BCtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (BCone)