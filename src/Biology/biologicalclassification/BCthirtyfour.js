...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.34</i><br></br>   Which of the following regarding Kingdom Plantae is correct?
</p>
      <div>
        <input
          type="radio"
        ...
        /> It includes all eukaryotic chlorpohyll containing organisms
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Few of its members are partially heterotrophic
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthirtyfour)