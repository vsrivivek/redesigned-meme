...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.14</i><br></br>    ________________is the most common method of reproduction in bacteria</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCfourteen)