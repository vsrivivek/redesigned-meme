...
const button=<button style={wStyle1} onClick={()=>navigate('/BCsummary')}>Summary</button>;
...
<h2 style={sStyle}>Exam Summary</h2>
  ...
  <tr  style={mystyle}>
    ...
    {/* <h4 style ={pstyle}>{props.score}</h4>    */}
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (BCscore)