...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.10</i><br></br>  _______________bacteria oxidise various inorganic substances such as nitrates, nitrites and ammonia and use the released energy ATP production. They play an important role in recycling nutrients(N,P,Fe,S etc)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCten)