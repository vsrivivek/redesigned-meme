...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p> <i>Question No.12</i><br></br> _______________are important decomposers that cause decay and decomposition of dead bodies of plants and animals
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwelve)