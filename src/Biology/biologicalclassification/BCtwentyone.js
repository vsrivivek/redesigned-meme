...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.21</h5> */}
    <p> <i>Question No.21</i><br></br> {props.BHealthanddiseaseTwentytwo}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseTwentytwoA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentytwoB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentytwoC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseTwentytwoD}
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCtwentyOne)