...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    {/* <h5>Question No.3 </h5> */}
    <p><i>Question No.3</i><br></br>In Whittaker's five kingdom system of classification, eukaryotes are distributed among_______________
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthree)