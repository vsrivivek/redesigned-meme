...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.32</i><br></br>Which of the following statements is correct regarding sexual reproduction in Basidiomycetes
</p>
      <div>
        <input
          type="radio"
        ...
        /> Plasmogamy occurs by the fusion of two somantic cells of different strains
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Basidiospores areexogenously produced on the bsidium
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthirtytwo)