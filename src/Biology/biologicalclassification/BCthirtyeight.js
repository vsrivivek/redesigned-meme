...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.38</i><br></br>   Read the given statements that describe certain infectious particle<br></br>
...
which of the following is referred to here
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/BCthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCthirtyeight)