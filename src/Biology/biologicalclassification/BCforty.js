...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <p><i>Question No.40</i><br></br>  Members of phycomycetes are found in<br></br>
...
choose from the options below
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/BCthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/BCthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (BCforty)