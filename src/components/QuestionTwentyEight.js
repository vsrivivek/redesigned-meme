...
function QuestionTwentyEight(props) {
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/twentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/twentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/twentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/twentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionTwentyEight)