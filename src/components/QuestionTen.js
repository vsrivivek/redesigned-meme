...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <p>  {props.BHealthanddiseaseEleven}</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> {props.BHealthanddiseaseElevenA}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseElevenB}
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseElevenC}
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> {props.BHealthanddiseaseElevenD}
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/eleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/eleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/eleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/nine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionTen)