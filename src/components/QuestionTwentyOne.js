...
function QuestionTwentyOne(props) {
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <p>  {props.BHealthanddiseaseTwentytwo}</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/twentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/twentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/twentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/twenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QuestionTwentyOne)