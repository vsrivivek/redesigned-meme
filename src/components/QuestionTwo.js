  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/three'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/three'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/three'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/one'))}>Previous</button>
        </div>
        </div> 
