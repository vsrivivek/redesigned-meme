...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br>The reaction occuring at the anode during the recharging of lead storage battery is</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> Pb+SO<sup>2-</sup><sub>4</sub>{'\u2192'}PbSO<sub>4</sub>+2e<sup>-</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Pb+PbO<sub>2</sub>+H<sub>2</sub>SO<sub>4</sub>{'\u2192'}2PbSO<sub>4</sub>+2H<sub>2</sub>O
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> PbSO<sub>4</sub>+2e<sup>-</sup>{'\u2192'}Pb+SO<sup>2-</sup><sub>4</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 2PbSO<sub>4</sub>+2H<sub>2</sub>O{'\u2192'}Pb+PbO<sub>2</sub>+2H<sub>2</sub>SO<sub>4</sub>
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtyseven)