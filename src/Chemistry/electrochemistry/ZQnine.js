...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br>  With increase in temparature the electrical conduction of an electrolyte
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQnine)