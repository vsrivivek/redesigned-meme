...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br> Which of the following statements is not true about a primary cell</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> It is source of electrical energy
        ...
        <input
          ...
          onClick={handleChange}
        /> A spontaneous redox reaction takes place in this cell
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtynine)