...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br>Which one of the following statements is true about an electrolytic cell
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        />  A spontaneous reaction occurs in the cell
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirteen)