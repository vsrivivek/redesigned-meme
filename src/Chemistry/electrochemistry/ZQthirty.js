...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br>The voltage cell whose half cells are given below is <br></br>
    Mg<sup>+2</sup>+2e<sup>-</sup>{'\u2192'}Mg; E=-2.37 v <br></br>
    Cu<sup>+2</sup>+2e<sup>-</sup>{'\u2192'}Mg; E=+0.34 v <br></br>
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirty)