...
<div style={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/ZQscore'))}>Score Page</button></div>
</div>
</div>
  )
}
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (ZQtimeup)