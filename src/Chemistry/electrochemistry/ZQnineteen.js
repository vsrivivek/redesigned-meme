...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br>  Three faradays of electricity was passed through an aqueous solution of iron(II) bromide. The weight of iron(at. wt= 56) deposited at the cathode is   </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQnineteen)