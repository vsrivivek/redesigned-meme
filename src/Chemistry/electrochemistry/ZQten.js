...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>The reaction taking place at anode is .......................and at cathode is called ..................during electrolysis
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQten)