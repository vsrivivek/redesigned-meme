...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> Molar conductivities at infinite dilution of AgNO<sub>3</sub>, NaNO<sub>3</sub>,and NaCl are 116.5, 105.2 and 110.3 cm<sup>2</sup>mol<sup>-1</sup> respectively. The limiting molar conductivity of AgCl in S cm<sup>2</sup>mol<sup>-1</sup> is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQseven)