...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.16</i><br></br> The amount of current in coloumbs passing through electrolytic cell in the electrolysis of aq. CuSO<sub>4</sub> solution if 0.3177 gms of copper was deposited at the cathode(at.wt of Cu= 63.54)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQsixteen)