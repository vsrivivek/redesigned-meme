...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>Number of coloumbs of quantity of current required to convert completely 1 mole of Mno<sup>-4</sup> ions in acid medium to one mole of Mn<sup>2+</sup> ions electrolytically is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQseventeen)