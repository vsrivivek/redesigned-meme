...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br>The type of chemical reaction that is generally employed in the construction of a galvanic cell</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwentytwo)