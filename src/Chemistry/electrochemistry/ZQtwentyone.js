...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br> The time required for complete decomposition of 2 moles of water using 8 amperes of current in seconds is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwentyOne)