...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br>The electrolysis cells one containing FeCl<sub>3</sub> and the other FeCl<sub>2</sub> are connected in series and electrolysis is carried out. The ratio of weights of iron deposited in the cells containing Fe<sup>3+</sup> and Fe<sup>2+</sup> respectively is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQeighteen)