...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br>In the H<sub>2</sub>-O<sub>2</sub> fuel cell the basic reaction is
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Conversion of H<sub>2</sub> to H<sub>2</sub>O<sub>2</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Decomposition of H<sub>2</sub>O
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Formation of O<sub>2</sub> form OH<sup>-</sup>
      </div>
       
      
    </form><br></br>
    <div className={props.buttons}>
    <button onClick={()=>(clickHanlderNext)(navigate('/ZQhirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtynine'))}>Save & Previous</button>
        <button onClick={()=>clickHanlderSan()}>Save</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtynine'))}>Mark For Review</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQforty)