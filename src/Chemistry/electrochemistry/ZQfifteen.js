...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br>The amount of the substance deposited at the electrode during electrolysisby the passage of one coloumb of current is known as      </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Electro chemical equivalent weight
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Electro chemical atomic weight
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQfifteen)