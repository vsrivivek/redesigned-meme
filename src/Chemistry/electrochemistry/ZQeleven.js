...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    When CuSO<sub>4</sub> solution is electrolysed, substance formed at anode is 
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQten'))}>Previous</button>
        ...
        <div className={props.right}>
          ...
          <button className={props.divA}onClick ={()=>(navigate('/ZQscore'))}>Submit Test</button>
        </div>
    </div>
    </div>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQeleven)