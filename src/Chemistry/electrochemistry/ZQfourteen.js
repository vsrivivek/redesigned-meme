...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br>The anode used in the electrolysis of MgCl<sub>2</sub> for extraction of Mg is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQfourteen)