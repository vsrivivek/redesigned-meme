...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>At infinite dilution, the equivalent conductivity of an electrolyte is given by {'\u2227'}<sup>o</sup><sub>eq</sub>= {'\u03bb'}<sup>o</sup><sub>c</sub>+{'\u03bb'}<sup>o</sup><sub>a</sub>.<br></br>
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQfour)