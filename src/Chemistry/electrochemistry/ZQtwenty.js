...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br> How long has a current of 3 amperes to be applied through a solution of silver nitrate to coat a metal surface of 80 Cm<sup>2</sup> with 0.005mm thick layer?( Density of silver= 10.5g/C.C)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwenty)