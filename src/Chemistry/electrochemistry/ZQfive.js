...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>he S.I. Unit of molar conductance is 
       </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQfive)