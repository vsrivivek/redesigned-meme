...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentythree()
    ...
    <form>
    <p><i>Question No.24</i><br></br> KCl is used in the construction of salt bridge because</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> K<sup>+</sup>, cl<sup>-</sup> are isoelectric
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> K<sup>+</sup>, cl<sup>-</sup> have unit charges
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        />  K<sup>+</sup>, cl<sup>-</sup> move with equal mobilities
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwentyfour)