...
const button=<button style={wStyle1} onClick={()=>navigate('/ZQsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (ZQscore)