...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Which one of the following solutions will have highest conductivity
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwo)