...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <form>
    <p><i>Question No.32</i><br></br> The standard electrode reduction potential of Zn,Ni,Cd and Pb are -0.77V,-0.25V,-0.40V and -0.13V respectively. Which of the following statements is correct</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> Cd displaces Zn from Zn<sup>++</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Ni displaces Cd from Cd<sup>++</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Pb displaces Cd from Cd<sup>++</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Zn displaces all the other metals from their solutions 
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtytwo)