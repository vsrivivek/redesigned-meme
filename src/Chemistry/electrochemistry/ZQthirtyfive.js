...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.35</i><br></br>The correct statemet in respect of standard electrode potential is
</p>
      <div>
        <input
          type="radio"
        ...
        /> Oxidation potential at 25<sup>o</sup>C and any concentration of the metal ions
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Oxidation potential at any temparature and 0.1 M concentration of the metal ions        
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Reduction potential at 25<sup>o</sup>C and 0.1 M concentration of the metal ions
        </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Reduction potential at 25<sup>o</sup>C and 1.0 M concentration of the metal ions
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtyfive)