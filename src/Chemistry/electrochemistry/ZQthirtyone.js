...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.31</i><br></br>The EMF of the cell in which one of the electrodes is standard hydrogen electrode is 1.2 volts. The potential of the other electrode is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtyone)