...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br>Which of the following statements is correct concerning a galvanic cell?</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> {'\u0394'}G of the cell reaction is positive
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwentyteight)