...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br> In the celln Zn| Zn <sup>+2</sup>(aq)||Cu<sup>2+</sup>|Cu
    </p>
      <div>
        <input
          type="radio"
        ...
        /> Copper electrode is negative electrode
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Zinc electrode is positive electrode
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Zinc reduces Cu<sup>2+</sup> ions
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Copper reduces Zn<sup>2+</sup> ions
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQtwentythree)