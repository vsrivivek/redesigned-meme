...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>  The device used to convert the chemical energy of H<sub>2</sub> gas into electrical energy is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQthirtyeight)