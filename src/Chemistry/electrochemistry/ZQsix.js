...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>The distance between the platinum electrodes of a conductivity cell is 0.8 cm and the area of cross section of each electrode is 1.2 cm<sup>2</sup>. The cell constant is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZQseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZQseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZQfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZQsix)