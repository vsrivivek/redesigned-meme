...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>The electronic configuration of halogen is
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/YMtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (YMone)