...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>  Shape of ClF<sub>3</sub> molecule is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwenty)