  ...
  if (stat==="Not Visited"){
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentyfive)