...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br>The oxidation state of ICl<sub>2</sub></p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMfourteen)