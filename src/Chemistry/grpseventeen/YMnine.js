...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br>Which of the following reaction is feasible?
      ...
      <div>
        ...
        /> Br<sub>2</sub>+2Cl<sup>-</sup>{'\u2192'}2Br<sup>-</sup>+Cl<sub>2</sub>
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Cl<sub>2</sub>+2F<sup>-</sup>{'\u2192'}2Cl<sup>-</sup>+F<sub>2</sub>
      <div>
        <input
          type="radio"
          value="c"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> I<sub>2</sub>+2Br{'\u2192'}2I<sup>-</sup>+Br<sub>2</sub>
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMnine)