...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br>  What is x in the following reaction?
      <br></br>KHSO<sub>4</sub>+F<sub>2</sub>{'\u2192'}HF+x
    </p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> K<sub>2</sub>S<sub>2</sub>O<sub>4</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> K<sub>2</sub>S<sub>2</sub>O<sub>2</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtysix)