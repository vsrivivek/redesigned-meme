...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>In their reaction with cold, dilute and hot, concentrated alkalies X<sub>2</sub>, the halogen(except flourine) respectively form
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> XO<sup>-</sup>,XO<sup>-</sup><sub>3</sub>          
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> XO<sup>-</sup><sub>2</sub>,XO<sup>-</sup><sub>4</sub>                   
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> XO<sup>-</sup><sub>3</sub>,XO<sup>-</sup><sub>4</sub>  
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMeight)