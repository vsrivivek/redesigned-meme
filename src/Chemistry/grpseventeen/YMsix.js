...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>Hydrogen Flouride has usually high boiling point because of
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMsix)