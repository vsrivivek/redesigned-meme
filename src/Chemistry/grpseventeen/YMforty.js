...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> The role of copper diaphragm in whytlaw-Gray's method is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Preventing the mixing of H<sub>2</sub> and F<sub>2</sub> 
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMforty)