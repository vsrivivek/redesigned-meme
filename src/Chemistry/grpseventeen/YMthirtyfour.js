...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>Chlorine atom, in its third excited state, reacts with flourine to form a compound X. The formula and shape of X are</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> ClF<sub>4</sub>, pentagonal bypyramidal
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> ClF<sub>7</sub>, pentagonal bypyramidal
        
      </div>
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtyfour)