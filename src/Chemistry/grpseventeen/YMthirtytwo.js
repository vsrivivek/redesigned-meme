...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <form>
    <p><i>Question No.32</i><br></br>Bleaching action of chlorine occurs in the presence of</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtytwo)