...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>   The type of bonds present in sulphur trioxide</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 3{'\u03c3'} bonds, one p{'\u03c0'}-p{'\u03c0'} two p{'\u03c0'}-d{'\u03c0'}
      </div> 
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtyeight)