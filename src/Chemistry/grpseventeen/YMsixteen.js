...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br> The shape of ClO<sub>4</sub><sup>-</sup></p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMsixteen)