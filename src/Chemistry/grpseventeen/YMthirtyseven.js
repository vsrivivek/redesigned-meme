...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br>Flourine reacts with dilute NaOH and forms a gaseous product A. The bond angle in molecule of A is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtyseven)