...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br>  Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentysix)
