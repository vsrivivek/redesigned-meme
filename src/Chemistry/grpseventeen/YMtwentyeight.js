...
const clickHanlderSan = function handleClickSan(){
 ...
 Select the option with the combination of incorrect statements
</p>     <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentyteight)