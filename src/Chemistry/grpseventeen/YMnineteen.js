...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br> Which of the following is a correct statement regarding hybrides of group 16 elements?
</p>
      <div>
        <input
          type="radio"
        ...
        /> The stability decreases from H<sub>2</sub>O to H<sub>2</sub>Te
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> The acidic character increases from H<sub>2</sub>O to H<sub>2</sub>Te
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> The reducing character decreases from H<sub>2</sub>O to H<sub>2</sub>Te
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> The bond dissociation enthalpy of E-H bond increases from H<sub>2</sub>O to H<sub>2</sub>Te
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMnineteen)