...
const button=<button style={wStyle1} onClick={()=>navigate('/YMsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (YMscore)