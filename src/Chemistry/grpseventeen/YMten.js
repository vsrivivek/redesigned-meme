...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>Which of the following is used in etching of glass
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMten)