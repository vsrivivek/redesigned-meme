...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> In their reactions with alkalies (in both cold and hot conditions) the halogens X<sub>2</sub>(except F<sub>2</sub>) form<br></br>
    I: XO<sup>-</sup><br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtyone)