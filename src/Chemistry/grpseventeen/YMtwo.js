...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Which of the following has the lowest ionisation potential?
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMone'))}>Previous</button>
        </div>
        </div> 
        ...
        <div className={props.right}>
          ...
          <button className={props.divA}onClick ={()=>(navigate('/PVscore'))}>Submit Test</button>
        </div>
    </div>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwo)