...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> Formula of tear gas is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwelve)