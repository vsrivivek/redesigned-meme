...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>The electron affinity values(in KJ mole<sup>-1</sup>) of three halogens X,Y and Z are respectively -349, -333 and -325.Then X, Y and Z respectively are
</p>
      <div>
        <input
          type="radio"
        ...
        /> F<sub>2</sub>,Cl<sub>2</sub> and Br<sub>2</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Cl<sub>2</sub>,F<sub>2</sub> and Br<sub>2</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Cl<sub>2</sub>Br<sub>2</sub> and F<sub>2</sub>
        </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Br<sub>2</sub>,Cl<sub>2</sub> and F<sub>2</sub>
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtyfive)