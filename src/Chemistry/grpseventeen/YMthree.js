...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.3</i><br></br> 2Br<sup>-</sup>+X<sub>2</sub>{'\u2192'}Br<sub>2</sub>+2X<sup>-</sup>. In this reaction X<sub>2</sub> is
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthree)