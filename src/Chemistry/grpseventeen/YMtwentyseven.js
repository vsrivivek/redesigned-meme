  ...
  if (stat==="Not Visited"){
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentyseven)