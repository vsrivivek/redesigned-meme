...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>The halogen which is most reactive in the halogenation of alkanes under sunlight is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMfour)