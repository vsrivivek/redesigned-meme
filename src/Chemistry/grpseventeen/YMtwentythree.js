...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br> [I<sub>3</sub>]<sup>-</sup> is isostructural with
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentythree)