...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    Which one of the following equation indicates the common laboratory method for the preparation of chlorine
 </p>
      <div>
        <input
          type="radio"
        ...
        /> 4HCl+O<sub>2</sub>{'\u2192'}2H<sub>2</sub>O+2Cl<sub>2</sub>
        </div>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          checked={optionten === 'c'}
          onClick={handleChange}
        /> 2Mg<sub>2</sub>OCl+O<sub>2</sub>{'\u2192'}4MgO+Cl<sub>2</sub>	
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionten === 'd'}
          onClick={handleChange}
        /> MnO<sub>2</sub>+4HCl{'\u2192'}MnCl<sub>2</sub>+H<sub>2</sub>O+Cl<sub>2</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMeleven)