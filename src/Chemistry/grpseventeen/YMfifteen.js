...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br> The strongest acid among the following is  </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMfifteen)