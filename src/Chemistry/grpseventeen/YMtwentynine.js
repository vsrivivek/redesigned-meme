...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>  F<sub>2</sub> On reaction produces <br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMtwentynine)