...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br>The oxide of nitrogen formed by thermal decomposition of NH<sub>4</sub>NO<sub>3</sub> is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMthirtynine)