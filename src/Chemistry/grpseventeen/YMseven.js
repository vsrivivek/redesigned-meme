...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br>  Among the following compounds which reacts with PCl<sub>5</sub>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMseven)