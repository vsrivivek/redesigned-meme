...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>Which of the following forms only one oxoacid</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YMeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YMeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YMeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YMsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YMseventeen)