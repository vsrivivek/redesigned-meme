...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.14</i><br></br> For a dilute solution, raoult's law states that</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> The relative lowering of vapour pressure is equal to the amount of solute in solution
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> The vapour pressure of the solutions is equal to the mole fraction of solute     </div>       
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPfourteen)