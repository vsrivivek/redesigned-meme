...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.27</i><br></br>Read the following Assertion and Reason.<br></br>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> A is false and R is true     </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwentyseven)