...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.9</i><br></br> In which mode of expression, the concentration of a solution remains independant of temparature
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPnine)