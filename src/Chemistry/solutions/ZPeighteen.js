...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.18</i><br></br> Which of the following solution pairs can be separated into its pure components by fractional distillation</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Water-C<sub>2</sub>H<sub>5</sub>OH
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPeighteen)