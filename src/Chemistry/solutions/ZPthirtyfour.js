...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.34</i><br></br>250 ml of a solution contains 6.3 gram of oxalic acid(Mol. wt= 126). What is the volume(in litres) of water to be added to the solution to make it a 0.1N solution</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirtyfour)