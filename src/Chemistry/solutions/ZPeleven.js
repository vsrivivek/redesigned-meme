...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    A solution is 36% water and 64% acetaldehyde(CH<sub>3</sub>CHO) by mass. Mole fraction of acetaldehyde is
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPeleven)