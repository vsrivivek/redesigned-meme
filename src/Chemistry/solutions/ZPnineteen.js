...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.19</i><br></br>  A binary solution of ethanol and n-heptane is an example of
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPnineteen)