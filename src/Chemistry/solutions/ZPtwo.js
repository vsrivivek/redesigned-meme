...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.2</i><br></br>Which of the following is incorrect
      ...
      <div>
        ...
        /> Mass of the gas dissolved is directly proportional to its pressure
      ...
      <div>
        <input
          ...
          checked={optionone === 'b'}
          onClick={handleChange}
        /> Mass of the gas dissolved is inversely proportional to its temparature
      ...
      <div>
        <input
          ...
          checked={optionone === 'c'}
          onClick={handleChange}
        /> A Soda-water bottle contains oxygen gas dissolved under pressure
      ...
      <div>
        <input
          ...
          checked={optionone=== 'd'}
          onClick={handleChange}
        /> Permanent gases are less soluble than temporary gases           
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwo)