...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.3</i><br></br> Mole fraction of CO<sub>2</sub> in the solution, if the partial pressure of CO<sub>2</sub> is 1 bar and its Henry's law constant is 1.67 k bar at 298K is
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthree)