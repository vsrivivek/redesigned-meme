...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.16</i><br></br> Which of the following solution will have high vapour pressure</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 0.1M Na<sub>2</sub>SO<sub>4</sub>
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> 0.1M Na<sub>3</sub>PO<sub>4</sub>
      </div>       
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPsixteen)