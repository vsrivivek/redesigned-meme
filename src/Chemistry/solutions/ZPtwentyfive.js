...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.25</i><br></br>The osmotic pressure of urea aqueous solution is 1.5 bar at 300 K. Concentration of this solution is R= 0.083L bar mol<sup>-1</sup>K<sup>-1</sup></p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwentyfive)