...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.15</i><br></br>Ideal solution is formed when its components    </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Have both zero heat of mixing as well as zero volume change
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Can be converted into ideal gas
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPfifteen)