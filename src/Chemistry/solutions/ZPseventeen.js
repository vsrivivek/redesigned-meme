...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.17</i><br></br>One mole of non volatile solute is dissolved in two moles of solvent. The relative lowering of vapour pressure is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPseventeen)