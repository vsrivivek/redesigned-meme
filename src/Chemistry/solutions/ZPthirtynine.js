...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.39</i><br></br> During the depression of freezing point experiment an equilibrium is established between the molecules of</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirtynine)