...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.35</i><br></br>X grams of water is mixed in 69 grams of ethanol. Molefraction of ethanol in the resultant solution is 0.6. What is the value of X in grams?
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirtyfive)