...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.40</i><br></br> In BaCl<sub>2</sub> ionises to an extent of 80% in aqueous solution, the value of van't Hoff factor is
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPforty)