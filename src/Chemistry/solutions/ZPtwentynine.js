...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.29</i><br></br> Effect of adding a non volatile solute to a solvent is  <br></br>
...
III: To increase its boiliing point<br></br>
 ...
 Select the correct answer</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwentynine)