...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.10</i><br></br>3.011 x 10<sup>21</sup> molecules of CO<sub>2</sub> were dissolved in 55.5 moles of water, its molality is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPten)