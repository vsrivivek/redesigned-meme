...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.13</i><br></br>The vapour pressure of a solution is 
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        />  Inversely proportional to mole fraction of solvent	
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  Directly proportional to mole fraction of a solute
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Inversely proportional to mole fraction of solute
      </div> 
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirteen)