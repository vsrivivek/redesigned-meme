...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.12</i><br></br> Equal masses of N<sub>2</sub>,O<sub>2</sub> and He are present in a gas mixture. Mole fraction of He is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwelve)