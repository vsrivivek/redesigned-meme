...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.5</i><br></br>The number of grams of anhydrous Na<sub>2</sub>CO<sub>3</sub> present in 250 ml of 0.25M solution is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPfive)