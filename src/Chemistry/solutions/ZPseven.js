...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.7</i><br></br>  Which of the following solutions is acidic in nature?
</p>
      <div>
        <input
          type="radio"
        ...
        /> 20 ml of 0.1M H<sub>2</sub>SO<sub>4</sub>+ 20 ml of 0.3M NaOH                                   
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionsix === 'b'}
          onClick={handleChange}
        /> 10 ml of 0.1M H<sub>2</sub>SO<sub>4</sub>+ 20 ml of 0.2M NaOH
      ...
      <div>
        <input
          ...
          checked={optionsix === 'c'}
          onClick={handleChange}
        /> 10 ml of 0.1M H<sub>2</sub>SO<sub>4</sub>+ 10 ml of 0.1M NaOH 
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionsix === 'd'}
          onClick={handleChange}
        /> 20 ml of 0.1M H<sub>2</sub>SO<sub>4</sub>+ 30 ml of 0.3M Ba(OH)<sub>2</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPseven)