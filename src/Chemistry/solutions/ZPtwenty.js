...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.20</i><br></br> Colligative properties of solutions are those which depend upon</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> The number of sulute particles
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPtwenty)