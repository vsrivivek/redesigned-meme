...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.31</i><br></br> 250 ml of sodium carbonate solution contains 2.65 grams of Na<sub>2</sub>CO<sub>3</sub>. 10 ml of this solution is added to x ml of water to obtain 0.001 M Na<sub>2</sub>CO<sub>3</sub> solution. What is the value of x in ml(Molecular weight of Na<sub>2</sub>Co<sub>3</sub>=106)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirtyone)