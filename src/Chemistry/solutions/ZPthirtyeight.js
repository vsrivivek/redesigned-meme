...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.38</i><br></br> The volumes of two HCl solutions A(0.5N) and B(0.1N) to be mixed for preparing 2 litre of 0.2N HCl solution</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 0.75 litre of A+ 0.25 litre of B
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZPthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZPthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZPthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZPthirtyeight)