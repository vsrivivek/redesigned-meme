...
const button=<button style={wStyle1} onClick={()=>navigate('/YTsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (YTscore)