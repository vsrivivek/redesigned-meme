...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.38</i><br></br>In the hardening stage of plaster of paris, the compound formed is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Orthorhombic CaSO<sub>4</sub>2H<sub>2</sub>O
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Monoclinic CaSO<sub>4</sub>2H<sub>2</sub>O
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirtyeight)