...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.9</i><br></br>When excess of NaOH is added to ZnSO<sub>4</sub> the following is formed finally 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTnine)