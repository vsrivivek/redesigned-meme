 ...
 <tbody  style={hStyle}>
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentyfour)