...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.30</i><br></br>What is the molecular formula of Plaster of Paris</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 2CaSO<sub>4</sub> 2H<sub>2</sub>O
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirty)