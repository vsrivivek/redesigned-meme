...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.14</i><br></br> Na<sub>2</sub>CO<sub>3</sub> and NaHCO<sub>3</sub> can be distinguished by treating with</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTfourteen)