...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.33</i><br></br>What are the products formed when Li<sub>2</sub>O<sub>3</sub> undergoes decomposition</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Li<sub>2</sub>O<sub>2</sub>+CO<sub>2</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirtythree)