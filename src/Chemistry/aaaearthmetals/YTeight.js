...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.8</h5> */}
    <p><i>Question No.8</i><br></br>Mixture of NaOH and CaO is called
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTeight)