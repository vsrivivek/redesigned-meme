...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.40</i><br></br>Which of the following pairs liberates a gas when react with each other
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTforty)