...
<div style={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/YTscore'))}>Confirm</button>    <button style={bstyle1} onClick={()=>navigate('/YTone')}>Cancel</button></div>
</div>
<p>{props.score}</p>
</div>
  )
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (YTconfirm)