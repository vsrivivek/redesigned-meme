...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.20</i><br></br>Compound formed when chlorine react with dry slacked lime is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwenty)