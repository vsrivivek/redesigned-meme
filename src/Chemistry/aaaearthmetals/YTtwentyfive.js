...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.25</i><br></br> Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentyfive)