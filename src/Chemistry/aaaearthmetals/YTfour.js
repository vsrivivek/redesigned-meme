...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.4</i><br></br>The best CO<sub>2</sub> absorber as well as source of oxygen in submarines is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/YTfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTfour)