...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.1</i><br></br>The blue colour of the alkali metals in liquor ammonia is due to</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/YTtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (YTone)