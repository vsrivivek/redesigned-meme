...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.36</i><br></br>What are the prodcuts formed when an aqueous solution of magnesium bicarbonate is boiled</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> MgCO<sub>3</sub>, H<sub>2</sub>O, CO<sub>2</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Mg(HCO<sub>3</sub>)<sub>2</sub>, H<sub>2</sub>O
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Mg,CO<sub>2</sub>, H<sub>2</sub>O    </div>
       
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirtysix)