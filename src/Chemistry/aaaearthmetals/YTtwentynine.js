...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.29</i><br></br>  Which of the following are readily soluble in water <br></br>
 ...
 Select the correct answer</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentynine)