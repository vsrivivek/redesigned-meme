 ...
 <tbody  style={hStyle}>
   ...
   Which of the following is not correct?
      ...
      <div>
        ...
        /> In Nelson method of NaOH preparation, Cl<sub>2</sub> is liberated at anode
        		 </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionten === 'b'}
          onClick={handleChange}
        /> With hot and concentrated NaOH,Cl<sub>2</sub> gas gives NaOCl              
      </div> 
      <div>
        <input
          type="radio"
          ...
          checked={optionten === 'c'}
          onClick={handleChange}
        /> NaOH reacts with white phosphorous giving phosphine
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionten === 'd'}
          onClick={handleChange}
        /> NaOH is used in rayon industry
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTeleven)