...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.12</i><br></br>The following is used in the softening of water
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwelve)