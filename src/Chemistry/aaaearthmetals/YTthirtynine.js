...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.39</i><br></br>Sodium is heated in air at 300<sup>o</sup>C to form X. X absorbs CO<sub>2</sub> and forms Na<sub>2</sub>CO<sub>3</sub> and Y. Idetify Y from the following options</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirtynine)