...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.22</i><br></br>Which of the following on thermal decomposition yields a basic as well as acidic oxide</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentytwo)