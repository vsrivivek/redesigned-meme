...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.23</i><br></br>  The setting of cement involves
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentythree)