...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.3</i><br></br>Which is the best peroxide used in quantitative analysis in identification of chromium salts
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthree)