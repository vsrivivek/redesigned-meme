...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.35</i><br></br>Which one of the following is the correct order for the decomposition temperarture of CaCO<sub>3</sub>(X),MgCO<sub>3</sub>(Y),BaCO<sub>3</sub>(Z)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTthirtyfive)