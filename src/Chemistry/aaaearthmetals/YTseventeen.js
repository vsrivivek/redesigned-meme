...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.17</i><br></br> The mixture of MgCl<sub>2</sub> and MgO is called</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTseventeen)