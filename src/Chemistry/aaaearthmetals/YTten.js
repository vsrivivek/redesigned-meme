...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.10</i><br></br>Consider the following reaction<br></br>
    6NaOH+3Cl<sub>2</sub>{'\u2192'}5NaCl+A+3H<sub>2</sub>O<br></br>
    What is the oxidation number of chlorine in A is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTten)