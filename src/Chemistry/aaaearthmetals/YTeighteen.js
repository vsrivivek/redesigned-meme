...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
      {/* <h5>Question No.8</h5> */}
    <p><i>Question No.18</i><br></br> Heat of hydration is maximum for</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTeighteen)