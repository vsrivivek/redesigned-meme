...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.2</i><br></br>Which one of the following alkali metals is a nutrient element required for the plant growth
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwo)