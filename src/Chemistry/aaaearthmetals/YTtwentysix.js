...
const clickHanlderSan = function handleClickSan(){
 ...
 <tbody  style={hStyle}>
   <tr >  
    ...
    <form>
    <p><i>Question No.26</i><br></br>sertion(A): Fused alkali metal hydrides conduct electricity and liberate H<sub>2</sub> at anode when electrolysed<br></br>
   ...
   Choose the correct answer from the options given below
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/YTtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/YTtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/YTtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (YTtwentysix)
