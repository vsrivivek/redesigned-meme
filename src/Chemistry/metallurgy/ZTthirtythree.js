...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> The chemical formula of feldspar is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> K<sub>2</sub>SO<sub>4</sub>.Al<sub>2</sub>(SO<sub>4</sub>)<sub>3</sub>.4Al(OH)<sub>3</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirtythree)