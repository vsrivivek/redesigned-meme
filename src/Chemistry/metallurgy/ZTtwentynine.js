...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>  Alumino thermic process is used for the spot welding of large iron structures is based upon the fact that</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> As compared to iron, Al has greater affinity for oxygen
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> As compared to Al, Fe has greater affinity for oxygen
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Reaction between Al and O<sub>2</sub> is endothermic
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwentynine)