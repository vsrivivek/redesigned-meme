...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br>Sulphide ore of zinc is concentrated by
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwentyOne)