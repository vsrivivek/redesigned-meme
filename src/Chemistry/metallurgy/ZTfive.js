...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>The chief constituent and impurity of the gemstone 'Ruby' respectively are
       </p>
      <div>
        <input
          type="radio"
        ...
        /> Cr<sub>2</sub>O<sub>3</sub> and Al			
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Al<sub>2</sub>O<sub>3</sub> and Cr	
      </div> 
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Al<sub>2</sub>O<sub>3</sub> and Cu
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTfive)