...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br>Copper matte contains</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirtynine)