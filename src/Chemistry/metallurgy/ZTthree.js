...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br> Asbestos is a silicate mineral of calcium and </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthree)