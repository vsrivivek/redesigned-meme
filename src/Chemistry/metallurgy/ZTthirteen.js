...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br> The term "coupling of reactions" means
</p>
      <div>
        <input
          type="radio"
        ...
        /> The point of intersection in Ellingham diagram		
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  Carrying two spontaneous reactions simultaneously			
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  Carrying bith spontaneous and non spontaneous reactions simultaneously					
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> Getting a very large positive Gibbs energy change
        
      </div> 
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirteen)