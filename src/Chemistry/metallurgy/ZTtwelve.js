...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br>Ellingham diagram provides the basis for
</p>
      <div>
        <input
          type="radio"
        ...
        /> The choice of reducing agent in the reduction of metal oxides in the extraction of metals                                        
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  The choice of oxidising agent for the conversion of the metal                                        
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> The rate of reduction of metal oxide into metal                   
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwelve)