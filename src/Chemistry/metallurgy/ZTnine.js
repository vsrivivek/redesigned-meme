...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br> The semiconductor grade metals of very high purity (viz., Si, Ge,B, Ga and In) are purified by
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTnine)