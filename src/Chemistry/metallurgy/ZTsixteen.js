...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br> In the extraction of copper, metal is formed in the Bessemer converter due to reaction</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 2Cu<sub>2</sub>O{'\u2192'}4Cu+O<sub>2</sub>
      </div>       
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTsixteen)