...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>In a refining method, the impure metal is heated on the sloping hearth of a furnace. The metal melts and flows down leaving behind the infusible material(dross) on the hearth. This refining method is called
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTeight)