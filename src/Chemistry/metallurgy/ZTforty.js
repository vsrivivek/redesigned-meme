...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> The ore which is concentrated by leaching is
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTforty)