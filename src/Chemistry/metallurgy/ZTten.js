...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>The principle involved in levigation process is
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Difference in electrical property
      </div> 
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTten)