...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>The composition of german silver is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTseventeen)