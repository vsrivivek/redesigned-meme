...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br>  If NaOH is added to an aqueous solution of zinc ions, a white precipitate appears and on adding excess of NaOH, the precipitate dissolves. In this solution zinc exist in the
    </p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Both Cationic and anionic parts
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwentythree)