...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br>Calamine is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwentytwo)