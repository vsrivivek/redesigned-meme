...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br>Identify the wrongly matched pair
      ...
      <div>
        <input
          ...
          checked={optionsix === 'd'}
          onClick={handleChange}
        /> Gangue:Fe<sub>2</sub>O<sub>3</sub>    
        
      </div>   
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTseven)