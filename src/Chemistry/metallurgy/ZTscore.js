...
const button=<button style={wStyle1} onClick={()=>navigate('/ZTsummary')}>Summary</button>;
...
name:state.name
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (ZTscore)