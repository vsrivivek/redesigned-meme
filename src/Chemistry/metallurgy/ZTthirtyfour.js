...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>In the castner's process of extraction of sodium, cathode is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirtyfour)