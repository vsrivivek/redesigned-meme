...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br> "Copper matter" is a mixture of </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTeighteen)