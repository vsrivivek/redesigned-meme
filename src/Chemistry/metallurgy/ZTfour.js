...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>In gold schmidt aluminothermic process, thermite contains
</p>
      <div>
        <input
          type="radio"
        ...
        /> 3 parts Fe<sub>2</sub>O<sub>3</sub> and two parts  Al                            
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> 3 parts Fe<sub>2</sub>O<sub>3</sub> and 1 part Al                              		        
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> 3 parts Al<sub>2</sub>O<sub>3</sub> and two parts Al                 
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 1 part Fe<sub>2</sub>O<sub>3</sub> and 1 part Al 

      </div>
    </form><br></br>
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTfour)