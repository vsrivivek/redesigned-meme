...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>The chemical reaction that involves roasting process is
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 2ZnS+3O<sub>2</sub>{'\u2192'}2ZnO+3SO<sub>2</sub>
        </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> FeO+SiO<sub>2</sub>{'\u2192'}FeSiO<sub>3</sub>  
         </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirtyfive)