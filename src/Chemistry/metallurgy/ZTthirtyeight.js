...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br> Reduction of a metal oxide state in liquid state is easier than in solid state because </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> The temparature attained is more
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTthirtyeight)