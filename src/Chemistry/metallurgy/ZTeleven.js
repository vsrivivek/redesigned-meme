...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    The gibbs energy change ({'\u0394'}G) for any process at any specified temparature is given by the equation
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTeleven)