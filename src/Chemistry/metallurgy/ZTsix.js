...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>Which of the following is called Fool's gold?
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTsix)