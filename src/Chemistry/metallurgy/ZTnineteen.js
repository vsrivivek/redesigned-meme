...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br> The percentage of Cu in blister copper is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTnineteen)