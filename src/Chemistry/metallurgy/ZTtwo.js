...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.2</i><br></br>Poling process is used 
</p>
      <div>
        <input
          type="radio"
        ...
        /> For the removal of Cu<sub>2</sub>O from Cu                  
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionone === 'b'}
          onClick={handleChange}
        /> For the removal of Al<sub>2</sub>O<sub>3</sub> from Al              
      ...
      <div>
        <input
          ...
          checked={optionone === 'c'}
          onClick={handleChange}
        /> For the removal of Fe<sub>2</sub>O<sub>3</sub> from Fe   
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwo)