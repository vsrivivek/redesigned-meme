...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>  Brass is an alloy of ......................and .......................</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZTtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZTtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZTnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZTtwenty)