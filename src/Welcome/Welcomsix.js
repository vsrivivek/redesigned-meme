...
if(checked===true){
  (props.timerUpdate(timeTwo)(navigate('/MIone')))
...
setErrmsg("* Please accept terms and conditions before proceeding.")
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Mathematical Induction</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomsix)
