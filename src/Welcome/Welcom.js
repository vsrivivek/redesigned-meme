...
const clickHandler= function handleClick(){
  if(checked===true){
    (props.timerUpdate(timeTwo)(navigate('/DYone')))
 ...
 return (<><div className={props.header} style={bStyle}>
    <table style={tStyle}>
 <tbody >
   <tr >  
 ...
 <ol style={fStyle}>
    <li>You can start the test by clicking the green button provided below the instructions.</li>
     ...
     <li>The test gets submitted automatically after the expiry of the alotted time. You can submit the test before the expiry of the duration by clicking the button provided for the purpose.</li>
 ...
 <input
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Diseases</button> 
  {/* <button onClick={()=>(props.timerUpdate(timeTwo)(navigate('/DYone')))}>Plant Kingdom</button> */}
  ...
  <button onClick={()=>(props.timerUpdate(timeTwo)(navigate('/QXone')))}>Oscillations</button>
