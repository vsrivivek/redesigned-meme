...
if(checked===true){
  (props.timerUpdate(timeTwo)(navigate('/BCone')))
...
setErrmsg("* Please accept terms and conditions before proceeding.")
 ...
 <input
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Start Test</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomone)
