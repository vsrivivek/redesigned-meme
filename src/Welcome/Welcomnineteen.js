...
const clickHandler= function handleClick(){
  if(checked===true){
    (props.timerUpdate(timeTwo)(navigate('/ZDone')))
 ...
 {/* <button style={bstyle} onClick={()=>(props.timerUpdate(timeTwo)(navigate('/ZDone')))}>Electrostatics</button>                  */}
 <button style={bstyle} onClick={()=>clickHandler()}>Electrostatics</button>                  
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomnineteen)
