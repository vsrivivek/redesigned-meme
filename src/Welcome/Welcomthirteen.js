...
const clickHandler= function handleClick(){
  if(checked===true){
    (props.timerUpdate(timeTwo)(navigate('/ZTone')))
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>General Principles of Metullurgy</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomthirteen)
