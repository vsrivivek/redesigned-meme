...
if(checked===true){
  (props.timerUpdate(timeTwo)(navigate('/PKone')))
...
setErrmsg("* Please accept terms and conditions before proceeding.")
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Plant Kingdom</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomtwo)
