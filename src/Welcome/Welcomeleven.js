...
const clickHandler= function handleClick(){
  if(checked===true){
    (props.timerUpdate(timeTwo)(navigate('/ZXone')))
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Wave Optics</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomeleven)
