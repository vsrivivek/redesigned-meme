...
if(checked===true){
  (props.timerUpdate(timeTwo)(navigate('/AKone')))
...
setErrmsg("* Please accept terms and conditions before proceeding.")
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Animal Kingdom</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomthree)
