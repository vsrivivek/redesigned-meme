...
import { useNavigate } from 'react-router-dom'
 ...
 function Welcomseventeen(props) {
  const logoStyle = {
    "margin-left":"100px",
    "border-radius":"25%",
...
const clickHandler= function handleClick(){
  if(checked===true){
    (props.timerUpdate(timeTwo)(navigate('/QMone')))
 ...
 {/* <h3>Hi {props.name}</h3> */}
  ...
  <button style={bstyle} onClick={()=>clickHandler()}>Gravitation</button>
...
const mapDispatchToProps=dispatch=>{
 ...
 export default connect(mapStateToProps,mapDispatchToProps) (Welcomseventeen)
