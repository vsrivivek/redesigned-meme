...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br> Two identical shaped metallic spheres A and B made up of same material of mass 'm' and  '4m' are heated to attain a temperature T<sub>1</sub> and then they are placed in a container maintained at a temperature T<sub>2</sub>(T<sub>2</sub>{'\u003c'}T<sub>1</sub>). The spheres are thermally insulated from each other. If R is the rate of change of temperature, then the ratio of R<sub>A</sub>& R<sub>B</sub> is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirtysix)