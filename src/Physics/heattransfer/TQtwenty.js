...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>  Two liquids of masses in ratio 3:2 are cooled under similar conditions. The ratio of times taken by them to cool to same temperature difference is 1/4. The ratio of their specific heats is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwenty)