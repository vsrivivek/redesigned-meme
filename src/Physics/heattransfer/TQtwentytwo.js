...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br>  A body at 1500K emits maximum energy at a wavelength 20000 A<sup>o</sup>. If the sun emits maximum energy at a wavelength of 5000A<sup>o</sup>, the temperature of the sun is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentytwo)