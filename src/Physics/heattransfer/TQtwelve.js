...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> For transmission of heat from one place to the other, medium is required in<br></br>
    a) Conduction<br></br>
    b) Convection<br></br>
    c) Radiation<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwelve)