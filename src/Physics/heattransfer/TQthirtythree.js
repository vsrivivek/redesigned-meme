...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> Three discs A,B and C having radii 2m,4m, and 6m respectively are coated with carbon black on their outer surefaces. The wavelengths corresponding to maximum intensity are 300 mm, 400mmm and 500mm respectively. The power radiated by them are Q<sub>A</sub>,Q<sub>B</sub>,Q<sub>C</sub> respectively</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirtythree)