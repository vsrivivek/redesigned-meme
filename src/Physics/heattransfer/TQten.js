...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br> Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQten)