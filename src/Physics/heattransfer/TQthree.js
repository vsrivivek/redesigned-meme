...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br>  The units of stefan's constant is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthree)