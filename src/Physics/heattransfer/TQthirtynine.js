...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br> The temperature of a body is increased from T<sub>1</sub>=127<sup>o</sup>C to T<sub>2</sub>=227<sup>o</sup>C. The ambient temperature is 27<sup>o</sup>C. The energies emitted per second by the body at T<sub>1</sub> and T<sub>2</sub> are E<sub>1</sub> and E<sub>2</sub> respectively. Then the ratio of E<sub>2</sub>/E<sub>1</sub> is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirtynine)