...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br> A black body at a temperature of 227<sup>o</sup>C, radiates heat at a rate of 20 calm<sup>-2</sup>s<sup>-1</sup>. When its temperature is raised to 727<sup>o</sup>C, the heat radiated by it in cal m<sup>-2</sup>s<sup>-1</sup> will be closest to </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirty)