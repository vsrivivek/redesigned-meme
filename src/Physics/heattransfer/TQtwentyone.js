...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br>   A cup of tea at 100<sup>o</sup>C cools at the rate of 0.02<sup>o</sup>Cs<sup>-1</sup>. When the room temperature is kept constant at 20<sup>o</sup>C. Then cooling rate for tea at 60<sup>o</sup>C is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentyOne)