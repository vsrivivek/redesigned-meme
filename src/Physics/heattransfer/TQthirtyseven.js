...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br> A body cools from 80<sup>o</sup>C to 50<sup>o</sup>C after a time interval of {'\u0394'}t. Assuming that the sorrounding temperature is 20<sup>o</sup>C, the temperature of of the body after time interval of 2{'\u0394'}t is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirtyseven)