...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br>  A wall is of two layers P and Q each made of different material. Both the layers have same thickness. The thermal conductivity of the material P is twice that of Q. Under thermal equilibrium, the temperature difference across the walls is 36<sup>o</sup>C. What is the temperature difference across the layer P?</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQfifteen)