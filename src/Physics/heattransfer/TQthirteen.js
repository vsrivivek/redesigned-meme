...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br> One end of metal bar 25cm in length is in steam, other in cotact with ice. If 12grams of ice melt per minute, conductivity of the metal in cal/cm sec<sup>o</sup>C(A=5cm<sup>2</sup>, Latent heat of ice= 80cal/gm) </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirteen)