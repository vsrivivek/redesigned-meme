...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br> The coefficients of thermal conductivity of copper, mercury & glass are respectively K<sub>c</sub>,K<sub>m</sub>,K<sub>g</sub> such that K<sub>c</sub>{'\u003e'}K<sub>m</sub>{'\u003e'}K<sub>g</sub>. If the same quantity of heat is to flow per second per unit area of each and corresponding temperature gradients are X<sub>c</sub>,X<sub>m</sub>,X<sub>g</sub>. Identify the increasing order of temperature gradients
</p> 
      <div>
        <input
          type="radio"
        ...
        /> X<sub>c</sub>,X<sub>m</sub> and X<sub>g</sub>
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  X<sub>m</sub>,X<sub>g</sub> and X<sub>c</sub>               
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  X<sub>g</sub>,X<sub>c</sub> and X<sub>m</sub>                  
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  X<sub>g</sub>,X<sub>m</sub> and X<sub>c</sub>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQeight)