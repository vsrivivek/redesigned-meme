...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    Identify the correct ones from the following<br></br>
    ...
    c) Felt is used for thermal insulation in preference to air</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQeleven)