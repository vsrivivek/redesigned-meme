...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br> If the temperature of a hot body is increased by 50%, the amount of radiation emitted by it increases approximatley by</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentyfive)