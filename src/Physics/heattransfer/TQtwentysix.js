...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br>   A small hole in a furnace acts like a blackbody.Its area is 1 cm<sup>2</sup>, and its temperature is same as that of the interior of the furnace,1727<sup>o</sup>C.How many joules are radiated out of the hole each second
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentysix)
