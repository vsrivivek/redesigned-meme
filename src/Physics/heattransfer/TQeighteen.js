...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br> An electric heater emits 1000 watt of thermal radiation. The coil has a surface area of 0.020m<sup>2</sup>. Assuming that the coil radiates like a black body, find its temperature</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQeighteen)