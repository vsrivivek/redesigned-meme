...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br> Which of the following radiations has the least wavelength </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentyseven)