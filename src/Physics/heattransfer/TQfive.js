...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br> At 0<sup>o</sup>C a body emits </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Electromagnetic radiation of fewer wavelengths than that are emitted by it at room temperature 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQfive)