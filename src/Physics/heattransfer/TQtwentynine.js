...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br> According to Newton's law of cooling, the rate of cooling of a body is proportional to ({'\u0394'}{'\u03b8'})<sup>n</sup>, when {'\u0394'}{'\u03b8'} is the difference of the temperature of the body and the sorroundings, and 'n' is equal to</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentynine)