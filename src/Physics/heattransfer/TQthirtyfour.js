...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br> The wavelength of maximum intensity of radiation emitted by a star is 289.8nm. The radiation intensity for the star is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 5.67x10<sup>12</sup>Wm<sup>-2</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 10.67x10<sup>7</sup>Wm<sup>-2</sup>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 10.67x10<sup>14</sup>Wm<sup>-2</sup>
      </div>
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQthirtyfour)