...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br>   Two stars A and B radiate maximum energy at 3600A<sup>o</sup> and 4800A<sup>o</sup> respectively.Then the ratio of the absolute temperatures of A and B is
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentythree)