...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br> At what rate is the enrgy radiated by a sphere of radius 5cm at 3000K and with an emissivity of 0.3?({'\u03c3'}=5.7x10<sup>-8</sup>Wm<sup>-2</sup>K<sup>-4</sup>)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQseventeen)