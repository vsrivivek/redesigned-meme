...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentythree()
    ...
    <form>
    <p><i>Question No.24</i><br></br>  The temperature of furnace is 2324<sup>o</sup>C and the intensity is maximum in its radiation spectrum nearly at 12000 A<sup>o</sup>. If the intensity of spectrum of a star is maximum at 4800A<sup>o</sup> nearly, then surface temperature of that star is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQtwentyfour)