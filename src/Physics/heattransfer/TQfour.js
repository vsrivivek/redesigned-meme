...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br> Thermos flask prevents heat loss by</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/TQFive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQFive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQFive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQFour)