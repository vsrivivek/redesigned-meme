...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br>  A black body at 227<sup>o</sup>C radiates energy at the rate of 10<sup>5</sup> J sec<sup>-1</sup>cm<sup>-2</sup>. To what temperature, it is to be heated so that it can emit the radiation at the rate of 10<sup>9</sup> J/sec-cm<sup>2</sup></p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQsixteen)