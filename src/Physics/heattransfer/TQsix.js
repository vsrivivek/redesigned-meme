...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br> Which of the following statements are wrong<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/TQseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/TQseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/TQseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/TQfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (TQsix)