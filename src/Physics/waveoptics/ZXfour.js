...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>The contrast between the fringes in any interference pattern depends on</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXFive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXFive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXFive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXFour)