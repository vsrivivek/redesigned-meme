...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br> Two waves originating from sources S<sub>1</sub> and S<sub>2</sub> having zero phase difference and common wavelength {'\u03bb'} will show completely destructive interference at a point P if (S<sub>1</sub>P-S<sub>2</sub>P) is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwentysix)
