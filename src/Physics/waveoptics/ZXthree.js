...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br> The apparent wavelength of light from a star decreases by 0.01% less than the actual wavelength. The velocity of star is </p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> 15 Kms<sup>-1</sup> moving away from the earth                          
      ...
      <div>
        <input
          ...
          checked={optiontwo === 'b'}
          onClick={handleChange}
        /> 15 Kms<sup>-1</sup> moving towards the earth                       
      </div> 
      <div>
        <input
          type="radio"
          ...
          checked={optiontwo === 'c'}
          onClick={handleChange}
        /> 30 Kms<sup>-1</sup> moving away from the earth                       	                          
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optiontwo=== 'd'}
          onClick={handleChange}
        /> 30 Kms<sup>-1</sup> moving towards the earth   
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthree)