...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Phase difference between two waves having same frequency(n) and same amplitude (A) is 2{'\u03c0'}/3. If these waves superimpose each other, then the resultant amplitude will be
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwo)