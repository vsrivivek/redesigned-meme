...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br>Light consisting of plane waves of wavelength {'\u03bb'}<sub>1</sub>=8x10<sup>-5</sup>cm and {'\u03bb'}<sub>2</sub>=6x10<sup>-5</sup>cm generates an interference pattern in Young's double slit experiment. If n<sub>1</sub> denotes the n<sub>1</sub><sup>th</sup> dark fringe due to light of wavelength {'\u03bb'}<sub>1</sub> which coincides with n<sub>2</sub><sup>th</sup> bright fringe due to light of wavelength {'\u03bb'}<sub>2</sub> then</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtysix)