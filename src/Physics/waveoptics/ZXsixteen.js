...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br>Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXsixteen)