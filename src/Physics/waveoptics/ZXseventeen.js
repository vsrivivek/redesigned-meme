...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>If white light is used in young's double-slit experiment, <br></br>
  ...
  select the correct answer from the following options
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXseventeen)