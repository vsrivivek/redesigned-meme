...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.13</i><br></br> Polaroid glass is used in sun-glasses because</p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> It reduces light intensity on account of polarisation		
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirteen)