...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>In a double slit experiment two interference patterns are seen on the screen. One pattern is due to light of wavelength 500 nm and second pattern is due to light of wavelength </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtyeight)