...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> A small circular disc is placed in the path of monochromatic light. The centre of the geometric shadow is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          checked={optionsix === 'd'}
          onClick={handleChange}
        /> Partly coloured and partly bright  
        
      </div>   
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXseven)