...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>On introducing a thin film, in the path of one of the two interfering beams the central fringe shifts by one fringe-width. if {'\u03bc'}=1.5, the thickness of the film is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwentyseven)