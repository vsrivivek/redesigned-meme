...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> Consider the following statements A and B and identify the correct answer<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwelve)