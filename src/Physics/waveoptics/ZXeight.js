...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseven()
    ...
    <form>
    <p><i>Question No.8</i><br></br>Ratio of intensities of consecutive maxima in a diffraction pattern due to a single slit is</p> 
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 1:4/(9{'\u03c0'}<sup>2</sup>):4/(25{'\u03c0'}<sup>2</sup>)  
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXnine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXnine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXnine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXeight)