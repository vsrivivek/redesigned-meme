...
// import ZXtimer from '../components/ZXtimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>A point source of light produces
      ...
      <div>
        <input
          ...
          checked={option === 'd'}
          onClick={handleChange}
        /> Both spherical and plane wavefront
 
      </div>
    </form> <br></br>
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/ZXtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXone)