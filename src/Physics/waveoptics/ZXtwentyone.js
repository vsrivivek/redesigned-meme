...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br> Refractive index of air is 1.0003. Required thickness of air column to have one more wavelength of yellow light than for the same thickness of vacuum is about </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwenty'))}>Previous</button>
        ...
        <div className={props.right}>
          ...
          <button className={props.divA}onClick ={()=>(navigate('/PTscore'))}>Submit Test</button>
        </div>
    </div>
    </div>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwentyOne)