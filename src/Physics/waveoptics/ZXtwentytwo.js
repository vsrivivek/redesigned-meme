...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br> When two coherent monochromatic light beams of intensities I and 4I are superimposed, the ratio between maximum and minimum intensities in the resultant beam is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwentytwo)