...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyeight()
    ...
    <form>
    <p><i>Question No.39</i><br></br> An unpolarised light is falling on a glass surface of refractive index 1.73. If the reflected and refracted rays are perpendicular to each other, then the angle of incidence is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXforty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXforty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXforty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtynine)