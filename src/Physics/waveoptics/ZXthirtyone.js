...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> Monochromatic light of wavelengths 400nm and 560nm are incident simultaneously and normally on double slits apparatus whose slits separation is 0.1nm and screen distance is 1m. Distance between areas of total darkness will be</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtyone)