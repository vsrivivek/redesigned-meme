...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>The limit of resolution of a telescope is 2.5x10<sup>-7</sup>radians. If the telescope is used to detect light of wavelength 500nm coming from a star, the diameter of the objective lens used by the telescope is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtyfive)