...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br>Young's double slit experiment is conducted with light of wavelength {'\u03bb'}. The intensity of bright fringe is I. The intensity at a point where the path difference 3{'\u03bb'}/4 is given by
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXnineteen)