...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>A beam of light is incident on a glass plate at an angle of incidence 60<sup>o</sup>.The reflected ray is polarised. What is the angle of refraction when the angle of incidence is 45<sup>o</sup></p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwentyfive)