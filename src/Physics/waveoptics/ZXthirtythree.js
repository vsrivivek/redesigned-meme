...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> A monochromatic light beam of wavelength 5896 A<sup>o</sup> is used in double slit experiment to get interference pattern on a screen. 9<sup>th</sup> bright fringe is seen at a particular position on the screen. At the same point on the screen, if 11<sup>th</sup> bright is to be seen, the wavelength of the light that is needed is (nearly)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtythree)