...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br> Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirteen'))}>Previous</button>
