...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br> Read the following Assertion and Reason.<br></br>
   ...
   Choose the correct answer from the options given below</p>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXfifteen)