...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>Calculate the minimum thickness of a soap film(n=1.33) that results in constructive interference in reflected light, if the film is illuminated with light whose wavelength in freespace is 532nm</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXthirtyfour)