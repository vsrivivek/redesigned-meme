...
const button=<button style={wStyle1} onClick={()=>navigate('/ZXsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (ZXscore)