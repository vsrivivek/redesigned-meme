...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br>Both light and sound waves produce diffraction. It is more difficult to observe the diffraction with light waves because
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXnine)