...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br>When polarised light is incident on a Tourmaline crystal of proper thickness<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXeighteen)