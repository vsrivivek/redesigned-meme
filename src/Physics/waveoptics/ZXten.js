...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>An unpolarised light is incident on a surface separating two transparent media of different optical densities at the polarising angle. Then the refracted ray and reflected rays are</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Inclined to each other at an angle of 45<sup>o</sup>                                    
      <div>
        <input
          type="radio"
          value="d"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXten)