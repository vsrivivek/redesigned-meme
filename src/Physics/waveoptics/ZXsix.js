...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br>The optical planeness of a surface can be tested using the phenomenon of</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXsix)