...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>In Young's experiment, wavelength of red light is 7.8x10<sup>-8</sup>cm. Value of n for which (n+1)<sup>th</sup> blue bright line coincides with n<sup>th</sup> red fringe is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZXtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZXtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZXnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZXtwenty)