...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    <form>
    <p><i>Question No.11</i><br></br> A particle executes simple harmonic motion between x=-A and x=+A. The time taken for it to go from 0 to A/2 is T<sub>1</sub> and to go from A/2 to A is T<sub>2</sub> then
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXeleven)