...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br>A clock pendulum made of invar has a period of 0.5sec at 20<sup>o</sup>C.If the clock is used in a climate where the temperature averages to 30<sup>o</sup>C,how much does the clock lose in each oscillation(for invar {'\u03b1'}= 9x10<sup>-7</sup>/<sup>o</sup>C, g= constant)
    <br></br>[<b>EAMCET 2009 M</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirty)