...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyone()
    ...
    <form>
    <p><i>Question No.32</i><br></br> A mass is suspended from the end of a spring. When the system is oscillating the amplitude of oscillation is 4 cm and maximum kinetic energy of oscillation of the system is 1 joule. Then the force constant of the spring is  
    <br></br>[<b>EAMCET 2012 M</b>]
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtytwo)