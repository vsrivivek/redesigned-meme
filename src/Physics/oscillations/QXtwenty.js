...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>  A uniform spring of force constant K is cut into two pieces, the lengths of which are in the ratio 1:2. A mass m is suspended from these parts successively. The time periods in the two cases will be in the ratio
    <br></br>[<b>Manipal 95</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwenty)