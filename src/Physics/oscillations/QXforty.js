...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> A ball connected to a mass-less spring is executing simple harmonic motion. If K and U are the kinetic and potential energy respectively, then the ratio K/U, when the displacement of the ball is one-third the amplitude will be
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXforty)