...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>   A girl swings on a cradle in sitting position. If she stands, the time period of cradle is
    <br></br>[<b>EAMCET 2008 M</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentynine)