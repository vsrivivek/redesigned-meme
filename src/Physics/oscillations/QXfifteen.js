...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.15</i><br></br>A particle of mass 10 grams is executing SHM with an amplitude of 0.5 m and angular frequency 10 radians/sec. The maximum value of the force acting on the particle during the course of oscillation is 
    <br></br>[<b>MPPMT 2000</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXfifteen)