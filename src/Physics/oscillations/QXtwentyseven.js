...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>A body of mass 'm' suspended to an ideal spring of force constant K. The expected change in the position of the body due to an additional force F acting vertically downwards is
    <br></br>[<b>EAMCET 2005 E</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentyseven)