...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.14</i><br></br> A body executing simple harmonic motion has a maximum acceleration has a maximum acceleration equal to 24ms<sup>-2</sup> and maximum velocity equal to 16ms<sup>-1</sup>. The amplitude of the SHM  (in metres) is<br></br>[<b>UPCET 2000</b>]
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXfourteen)