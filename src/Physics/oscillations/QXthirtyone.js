...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> A mass M is suspended from a light spring. An additional mass m is added, displaces the spring further by a disyance 'x'. Now the combined mass will oscillate with a period
    <br></br>[<b>EAMCET 2010 M</b>]
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtyone)