...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.38</i><br></br> Consider a pair of identical pendulums, which oscillate with equal amplitude independently such that when one pendulum is at its extreme position making an angle of 4<sup>o</sup> to the right with the vertical, the other pendulum makes an angle of 2<sup>o</sup> to the left of the vertical. The phase difference between the pendulums is
      <br></br>[<b>EAMCET 2019 AP M</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtyeight)