...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>The ideal spring with spring constant K is hung from the ceiling and a block of mass M is attached to its lower end. The mass is released with the spring initially unstretched. Then the maximum extension in the spring is 
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXfive)