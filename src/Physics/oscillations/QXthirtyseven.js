...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br>The amplitude of a damped oscillator becomes half in one minute. The amplitude after 3 minutes will be 1/x times the original. Then x is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtyseven)