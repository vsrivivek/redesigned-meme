...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br>  A body of mass 1 kg is executing Simple Harmonic Motion. Its displacement 'y' cm at 't' seconds is given by<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentyOne)