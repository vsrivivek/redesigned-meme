...
// import QXtimer from '../components/QXtimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br>A particle executes SHM. Then the graph of velocity as a function of displacement is<br></br>[<b>CBSE 97</b>]
 </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/QXtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QXone)