...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br> In forced oscillation of a particle the amplitude is maximum for a frequency {'\u03c9'}<sub>1</sub> of the force, while the energy is maximum for a frquency {'\u03c9'}<sub>2</sub> of the force, then 
    <br></br>[<b>AIEEE 2004</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          checked={optiontwo === 'c'}
          onClick={handleChange}
        /> {'\u03c9'}<sub>1</sub>{'\u003c'}{'\u03c9'}<sub>2</sub> when damping is small and {'\u03c9'}<sub>1</sub>{'\u003e'}{'\u03c9'}<sub>2</sub> when damping is large           	                          
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthree)