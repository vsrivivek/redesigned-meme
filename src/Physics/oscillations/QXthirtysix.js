...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br> A heavy brass sphere is hung from a weightless elsatic cord and acts as a simple pendulum with its period of oscillation T. The sphere is immersed in non-viscous liquid of density 1/10 of the density of brass. Then it will act as a simple pendulum of period
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtysix)