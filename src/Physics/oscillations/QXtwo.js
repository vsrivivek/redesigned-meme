...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>A particle at the end of a spring executes SHM with a period t<sub>1</sub>, while the corresponding period for another spring is t<sub>2</sub>. If the period of oscillation with two springs in series T, then
    <br></br>[<b>AIEEE 2004</b>]
      ...
      <div>
        <input
          ...
          checked={optionone === 'b'}
          onClick={handleChange}
        /> T<sup>2</sup>=t<sub>1</sub><sup>2</sup>+t<sub>2</sub><sup>2</sup>            
      ...
      <div>
        <input
          ...
          checked={optionone === 'c'}
          onClick={handleChange}
        /> T<sup>-1</sup>=t<sub>1</sub><sup>-1</sup>+t<sub>2</sub><sup>-1</sup>              
      </div>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwo)