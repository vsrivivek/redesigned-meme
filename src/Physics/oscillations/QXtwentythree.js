...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentytwo()
    ...
    <form>
    <p><i>Question No.23</i><br></br>  Two particles P and Q start from origin and execute simple harmonic motion along X-axis with same amplitude but with periods 3 seconds and 6 seconds respectively. The ratio of the velocities of P and Q when they meet is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentythree)