...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br>  The displacement of a particle of mass 3 gm executing simple harmonic motion is given by y=3sin(0.2t) in SI units. The kinetic energy of the particle at a point which is at a distance equal to 1/3 of its amplitude from its mean position is
    <br></br>[<b>EAMCET 2007 M</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentyteight)