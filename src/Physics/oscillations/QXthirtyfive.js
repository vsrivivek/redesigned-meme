...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>Maximum velocity in SHM is V<sub>m</sub>. The average velocity during motion from one extreme point to the other extreme will be 
    <br></br>[<b>EAMCET 2015 AP E</b>]
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXthirtyfive)