...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>The displacement y of a wave travelling in th X- direction is given by y=10<sup>-4</sup>sin(600t-2x+{'\u03c0'}/3) metre, where x is expressed in metres and 't' in seconds. The speed of wave motion in ms<sup>-1</sup> is
    <br></br>[<b>AIEEE 2003</b>]
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/QXFive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXFive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXFive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXFour)