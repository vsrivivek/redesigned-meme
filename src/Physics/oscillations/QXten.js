...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>If a simple pendulum of length l has maximum angular displacement {'\u03b8'}, then the maximum KE of the bob of mass 'm' is  <br></br>[<b>AFMC 2002</b>]
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXten)