...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> A simple pendulum has atime period T<sub>1</sub> when on the earth's surface, and T<sub>2</sub> when it takes to a height R above the earth's surface, where 'R' is the radius of the earth. The value T<sub>2</sub>/T<sub>1</sub> is
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwelve)