...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> The angular velocities of three bodies in simple harmonic motion are {'\u03c9'}<sub>1</sub>,{'\u03c9'}<sub>2</sub>,{'\u03c9'}<sub>3</sub> with their respective amplitudes as A<sub>1</sub>,A<sub>2</sub>,A<sub>3</sub>. If all three bodies have same mass and velocity then
    <br></br>[<b>BHU 2002</b>]
</p>
      <div>
        <input
        ...
        /> A<sub>1</sub>{'\u03c9'}<sub>1</sub>=A<sub>2</sub>{'\u03c9'}<sub>2</sub>=A<sub>3</sub>{'\u03c9'}<sub>3</sub>                        
      </div>
      <div>
        <input
          type="radio"
          ...
          checked={optionsix === 'b'}
          onClick={handleChange}
        /> A<sub>1</sub>{'\u03c9'}<sub>1</sub><sup>2</sup>=A<sub>2</sub>{'\u03c9'}<sub>2</sub><sup>2</sup>=A<sub>3</sub>{'\u03c9'}<sub>3</sub><sup>2</sup>                       
      ...
      <div>
        <input
          ...
          checked={optionsix === 'c'}
          onClick={handleChange}
        /> A<sub>1</sub><sup>2</sup>{'\u03c9'}<sub>1</sub>=A<sub>2</sub><sup>2</sup>{'\u03c9'}<sub>2</sub>=A<sub>3</sub><sup>2</sup>{'\u03c9'}<sub>3</sub>                       
      ...
      <div>
        <input
          ...
          checked={optionsix === 'd'}
          onClick={handleChange}
        /> A<sub>1</sub><sup>2</sup>{'\u03c9'}<sub>1</sub><sup>2</sup>=A<sub>2</sub><sup>2</sup>{'\u03c9'}<sub>2</sub><sup>2</sup>=A<sub>3</sub><sup>2</sup>{'\u03c9'}<sub>3</sub><sup>2</sup>                      
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXseven)