...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfour()
    ...
    <form>
    <p><i>Question No.25</i><br></br>An object is attached to the bottom of a light vertical spring and set vibrating. The maximum speed of the object is 15cms<sup>-1</sup> and the period is 628 milli-seconds. The amplitude of the motion in centimetres is 
    <br></br>[<b>EAMCET 2003 E</b>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QXtwentysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QXtwentysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QXtwentyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QXtwentyfive)