...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentythree()
    ...
    <form>
    <p><i>Question No.24</i><br></br>  The work done to remove a body of mass 2 Kg from the surface of the earth of radius 'r'(6400 km) and acceleration due to gravity 'g'(10ms<sup>-2</sup>) </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> 0.128x10<sup>8</sup> J  
      </div>
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwentyfour)