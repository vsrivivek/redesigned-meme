...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.16</i><br></br> The value of accelaration due to gravity 'g' on the surface of the moon with radius 1/2 that of the earth and same mean density as that of the earth</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMsixteen)