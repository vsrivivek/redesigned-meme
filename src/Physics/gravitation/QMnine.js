...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br> Four equations expressing relationships between physical quantities are given below. g gravitational field strength,r is radius, {'\u03c1'} is density, G is the universal constant of gravitation, m is mass, and T is time period. Which of the following equations is(are) homogeneous<br></br>
a) gT<sup>2</sup>=4{'\u03c0'}r<sup>2</sup><br></br>
b) g=4{'\u03c0'}{'\u03c1'}Gr<sup>2</sup>/3<br></br>
c) gr<sup>2</sup>=Gm<br></br>
d) g=4{'\u03c0'}{'\u03c1'}Gr/3<br></br>
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMnine)