...
const button=<button style={wStyle1} onClick={()=>navigate('/QMsummary')}>Summary</button>;
...
<h2 style={sStyle}>Exam Summary</h2>
  ...
  <tr  style={mystyle}>
    ...
    {/* <p><button onClick={()=>(navigate('/DYsummary'))}>Summary</button></p>  */}
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (QMscore)