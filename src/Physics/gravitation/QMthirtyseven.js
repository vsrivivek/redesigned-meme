...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br> R and r are the radii of earth and moon respectively. {'\u03c1'}<sub>e</sub> and {'\u03c1'}<sub>m</sub> are the densities of earth and monn respectively. The ratio of the acceleration due to gravity on the surfaces of earth to moon is
      </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirtyseven)