...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br>  If the earth stops rotating about its axis, the value of acceleration due to gravity at the equator is 'g'. Then the angular speed of rotation of the earth about that axis so that accelaration due to gravity at the equator would become g/2 (R is the radius of the earth) 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMnineteen)