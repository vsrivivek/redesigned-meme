...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.5</i><br></br> Which of the following statements is true?<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMfive)