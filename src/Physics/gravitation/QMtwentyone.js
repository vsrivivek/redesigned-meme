...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br> If T is absolute temperature of a planet, v<sub>e</sub> is the escape velocity from its surface and R is universal gas constant, then gas of molecular weight M can be retained on the surface of the planet if </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwentyOne)