...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br>  Two particles of masses 4Kg and 8Kg are kept at x=-2 and x=4 respectively. Then the net force acting on the third particle of mass 1 Kg kept at the origin in Newton is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirteen)