...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br> According to kepler's second law, line joining the planet to the sun sweeps out equal areas in equal time intervals. This suggests that for the planet</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Transeverse acceleration is zero               
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/QMFive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMFive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMFive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMFour)