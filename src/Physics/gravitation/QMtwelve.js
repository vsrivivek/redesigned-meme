...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureleven()
    ...
    <form>
    <p><i>Question No.12</i><br></br> A small planet revolving around a large star in a circular orbit of radius 'R' with a period of revolution 'T'. The gravitational force of attraction between the star and the planet is proportional R<sup>-5/2</sup> then T<sup>2</sup> is proportional to 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMeleven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwelve)