...
// import QMtimer from '../components/QMtimer ';
...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFour()
    ...
    <form>
    <p><i>Question No.1</i><br></br> Gravitational force can be called as
    ...
    <div className={props.buttons}>
        <button  onClick={()=>(clickHanlderNext)(navigate('/QMtwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwo'))}>Save & Next</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QMone)