...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> he binding energy of the system of earth and its satellite orbiting round the earth in a circular orbit is E. if m is mass of that satellite, its linear speed in that orbit is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirtyone)