...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> mass M is divided into two parts 'x'm and (1-x)m. For a given separation, the value of x for which the gravitational attrcation between the two pieces beomces maximum is
</p>
      <div>
        <input
          type="radio"
    ...
    <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMforty)