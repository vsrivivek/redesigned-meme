...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfourteen()
    ...
    <form>
    <p><i>Question No.15</i><br></br>   When a planet is orbiting around the sun in an elliptical orbit, r<sub>1</sub> and r<sub>2</sub> denote its closest and farthest distances from the sun. Then the ratio of the magnitudes of maximum and minimum gravitational forces between them is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> r<sub>1</sub><sup>2</sup>:r<sub>2</sub><sup>2</sup>
      </div> 
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> r<sub>2</sub><sup>2</sup>:r<sub>1</sub><sup>2</sup> 
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMfifteen)