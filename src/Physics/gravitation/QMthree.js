...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br>  A satellite launching station should be </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthree)