...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.23</i><br></br>  If R is radius of the earth, the amount of work done in lifting a body of mass m from the surface of the earth to a height equal to n times the radius of the earth is(g is acceleration due to gravity on the surface)
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwentythree)