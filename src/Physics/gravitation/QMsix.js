...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfive()
    ...
    <form>
    <p><i>Question No.6</i><br></br> Read the following Assertion and Reason.<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMsix)