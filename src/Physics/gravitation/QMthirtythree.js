...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtytwo()
    ...
    <form>
    <p><i>Question No.33</i><br></br> For a planet moving around the sun in an elliptical orbit of semimajor and semiminor axes a and b respectively, and period T. Then which of the following is true<br></br>
    ...
    D) The planet moves with a constant speed around the sun<br></br>
    </p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirtythree)