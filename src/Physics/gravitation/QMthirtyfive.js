...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.35</i><br></br> Two heavenly bodies S<sub>1</sub> and S<sub>2</sub>, not far off from each other are seen to revolve in orbits
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> With S<sub>1</sub> fixed and S<sub>2</sub> moving around S<sub>1</sub>
                </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> With S<sub>2</sub> fixed and S<sub>1</sub> moving around S<sub>2</sub>
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirtyfive)