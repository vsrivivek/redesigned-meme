...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursix()
    ...
    <form>
    <p><i>Question No.7</i><br></br> Read the following Assertion and Reason.<br></br>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMseven)