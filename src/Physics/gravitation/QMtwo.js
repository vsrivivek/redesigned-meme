...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br> The unit of the quantity g/G in SI will be
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwo)