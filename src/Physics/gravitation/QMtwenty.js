...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br> A tunnel is dug along a diameter of the earth. If M is the mass of the earth, then the force on a particle of mass m placed in that tunnel at distance x from the centre is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwenty)