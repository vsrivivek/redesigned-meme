...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourseventeen()
    ...
    <form>
    <p><i>Question No.18</i><br></br> If 'g' is the acceleration due to gravity on the surface of the earh, having radius R, the height at which the acceleration due to gravity reduces to g/2 is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMnineteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMnineteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMnineteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMseventeen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMeighteen)