...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirteen()
    ...
    <form>
    <p><i>Question No.14</i><br></br> Three bodies each of mass m are placed at the corners of a square of side 'a'. The force on unit mass kept at the fourth corner is </p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Gm[{'\u221a'}2+(1/2)]/a<sup>2</sup> </div>       
      
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/QMfifteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMfifteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMfifteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMfourteen)