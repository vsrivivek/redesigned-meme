...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br> What would be the maximum height reached by the body if the body is projected vertically from the surface of the earth of radius R with a velocity equal to half of the escape velocity?</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMthirtyfour)