...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyseven()
    ...
    <form>
    <p><i>Question No.28</i><br></br> The work done due to increase in radius of the orbit of a satellite of mass m from 3r to 4r is (Where M is the mass of the planet)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwentyteight)