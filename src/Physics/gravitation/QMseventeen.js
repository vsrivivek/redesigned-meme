...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br> If the change in the value of 'g' at a height 'h' above the surface of the earth is the same as at a depth 'x' below it, and when both x and h are much smaller than the radius of the earth</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMseventeen)