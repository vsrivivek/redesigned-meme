...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br> A satellite is moving very close to the surface of the earth. In order to displace it to infinity, its velocity must be increased by</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/QMtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/QMtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/QMtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (QMtwentyseven)