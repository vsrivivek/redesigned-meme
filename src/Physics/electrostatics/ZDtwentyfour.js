...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.24</i><br></br> A parallel plate capacitor of capacity 5{'\u03bc'}F and plate separation 6cm is connected to a 1V battery and is charged. A dielectric of dielectric constant 4 and thickness 4cm is introduced into the capacitor. The additional charge that flows into the capacitor from the battery is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentyfour)