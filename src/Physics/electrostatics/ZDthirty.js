...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentynine()
    ...
    <form>
    <p><i>Question No.30</i><br></br>A charged sphere of diameter 4cm has a charge density of 10<sup>-4</sup>cou/cm<sup>2</sup>. The work done in joules when a charge of 40 nano-coloumbs is moved from infinity to a point which is at a distance of 2cm from the surface of the sphere, is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentynine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirty)