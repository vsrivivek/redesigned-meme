...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyfive()
    ...
    <form>
    <p><i>Question No.26</i><br></br> The time in seconds required to produce a potential difference of 20V across a capacitor of 1000{'\u03bc'}F when it is charged at the steady rate of 200{'\u03bc'}C/s is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentysix)
