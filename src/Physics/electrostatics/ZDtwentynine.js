...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyeight()
    ...
    <form>
    <p><i>Question No.29</i><br></br>A capacitor of capacity 10{'\u03c0'}F is charged to 40V and second capacitor of capacity 15{'\u03c0'}F is charged to 30 V.If they are connected in parallel the amount of charge that flows from the smaller capacitor to higher capacitor in {'\u03c0'}C is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentynine)