...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournine()
    ...
    <form>
    <p><i>Question No.10</i><br></br>A capacitor of 1{'\u03bc'}F withstands a maximum voltage of 6 kilovolt while another capacitor of 2{'\u03bc'}F withstands a maximum voltage of 4 kilovolt. If the two capacitors are connected in series, the system will withstand a maximum voltage of</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDeleven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDeleven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDeleven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDnine'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDten)