...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureighteen()
    ...
    <form>
    <p><i>Question No.19</i><br></br>A charged particle q is placed at the centre O of a cube of length L. Another same charge q is placed at a distance L from O. The electric flux through the cube is
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwenty'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwenty'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwenty'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDeighteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDnineteen)