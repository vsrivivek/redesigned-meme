...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourone()
    ...
    <form>
    <p><i>Question No.2</i><br></br>Three charges 'q','Q' and '4q' are placed in a straight line of length 'l' at points at distance of '0','l/2','l' respectively from one end. In order to make the net force on 'q' zero, the charge Q must be equal to   </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDone'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwo)