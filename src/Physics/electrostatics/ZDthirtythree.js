...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.33</i><br></br>A metal plate of thickness 2mm and area 36{'\u03c0'}cm<sup>2</sup> is slide into a parallel plate capacitor of plate spacing 6mm and an area 36{'\u03c0'}cm<sup>2</sup>. The metal plate is at a distance 3mm from one of the plates.What is the capacitance of this arrangement</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtyfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtyfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtytwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtythree)