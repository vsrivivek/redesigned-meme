...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirty()
    ...
    <form>
    <p><i>Question No.31</i><br></br> An infinite line of charge with uniform line charge density of 1 C/m is placed along the y-axis. A charge of 1C is placed on the X-axis at a distance of d=3m from the origin. At what distance (r) from the origin on the X-axis, the total electric field is zero(Assume 0{'\u003c'}r{'\u003c'}d) 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtyone)