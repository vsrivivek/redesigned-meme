...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwo()
    ...
    <form>
    <p><i>Question No.3</i><br></br> Two equal negative charges -q are fixed at the points (o,a) and (0,-a) on the Y-axis. A positive charge Q is released from rest at the point (2a,0) on the X-axis. The charge Q will </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDfour'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDfour'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDfour'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwo'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthree)