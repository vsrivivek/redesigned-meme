...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.28</i><br></br>The capacities of three capacitors are in the raatio of 1:2:3. Their equivalent capacity when connected in parallel is 60/11{'\u03bc'}F more than when they are connected in series. The individual capacities of capacitors in {'\u03bc'}F are</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentyteight)