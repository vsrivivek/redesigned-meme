...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfour()
    ...
    <form>
    <p><i>Question No.5</i><br></br>The capacities of two conductors are C<sub>1</sub>,C<sub>2</sub> and their respective potentials are V<sub>1</sub>,V<sub>2</sub>.If they are connected by a thin wire, then the loss of energy will be   </p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> [C<sub>1</sub>C<sub>2</sub>(V<sub>1</sub>+V<sub>2</sub>)]/2(C<sub>1</sub>+C<sub>2</sub>)		
      </div>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> [C<sub>1</sub>C<sub>2</sub>(V<sub>1</sub>+V<sub>2</sub>)<sup>2</sup>]/2(C<sub>1</sub>+C<sub>2</sub>)	
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> [(C<sub>1</sub>+C<sub>2</sub>)(V<sub>1</sub>-V<sub>2</sub>)]/(C<sub>1</sub>C<sub>2</sub>)
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDsix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDsix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDsix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDfive)