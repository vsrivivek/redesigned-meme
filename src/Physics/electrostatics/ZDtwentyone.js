...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwenty()
    ...
    <form>
    <p><i>Question No.21</i><br></br>Two charges of 4{'\u03bc'}C each are placed at the corners of A and B of an equilateral triangle ABC of side length 0.2 m in air. The electric potential at C is[1/(4{'\u03c0'}{'\u03b5'}<sub>0</sub>)=9x10<sup>9</sup>N-m<sup>2</sup>c<sup>-2</sup>] </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentytwo'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentytwo'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentytwo'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwenty'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentyOne)