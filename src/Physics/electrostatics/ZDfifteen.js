...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.15</i><br></br> There is an electric field E in X-direction. If work done in moving a charge 0.2C through a distance of 2m along a line making an angle 60<sup>o</sup> with X-axis is 4.0J. The value of E is  </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDsixteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDsixteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDsixteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDfourteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDfifteen)