...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoursixteen()
    ...
    <form>
    <p><i>Question No.17</i><br></br>An electric dipole is placed along the X-axis at the origin O. A point P ia at a distance of 20cm from this origin such that OP makes an angle {'\u03c0'}/3 with the X-axis.If electric field at P makes and angle '{'\u03b8'}' with X-axis, the value of '{'\u03b8'}' is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDeighteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDeighteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDeighteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDsixteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDseventeen)