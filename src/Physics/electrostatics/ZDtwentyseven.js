...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentysix()
    ...
    <form>
    <p><i>Question No.27</i><br></br>Two electrons separated by a distance of 'r' experience force 'F' between them. The force between a proton and singly ionised helium atom separated by a distance 2r is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentysix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentyseven)