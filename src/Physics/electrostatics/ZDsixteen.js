...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourfifteen()
    ...
    <form>
    <p><i>Question No.16</i><br></br>Two equal charges q of opposite sign separated by a distance 2a constitute an electric dipole of dipole moment P. If P is a point at a distance r from the centre of the dipole and the line joining centre to this point makes an angle '{'\u03b8'}' with the axis the dipole,then the potential at the point P is given by (r{'\u003e'}{'\u003e'}2d)
      ...
      <div>
        ...
        /> V=Pcos{'\u03b8'}/(4{'\u03c0'}{'\u03b5'}<sub>0</sub>r<sup>2</sup>)
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> V=Pcos{'\u03b8'}/(4{'\u03c0'}{'\u03b5'}<sub>0</sub>r<sup>3</sup>)
      </div>       
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDseventeen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDseventeen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDseventeen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDfifteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDsixteen)