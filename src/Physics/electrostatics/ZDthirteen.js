...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwelve()
    ...
    <form>
    <p><i>Question No.13</i><br></br> A condenser of capacity C<sub>1</sub> is charged to a certain potential. The electrostatic energy stored in it is 'U'. If it is connected to another uncharged condenser of capacity C<sub>2</sub> in parallel, the energy dissipated in the process will be 
</p>
      <div>
        <input
          type="radio"
        ...
        /> C<sub>2</sub>U/(C<sub>1</sub>+C<sub>2</sub>)
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> C<sub>1</sub>U/(C<sub>1</sub>+C<sub>2</sub>)
      </div> 
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        />  [(C<sub>1</sub>-C<sub>2</sub>)/(C<sub>1</sub>+C<sub>2</sub>)]<sup>2</sup>U
      </div>
      <div>
        <input
          type="radio"
          ...
          onClick={handleChange}
        /> [C<sub>1</sub>C<sub>2</sub>/2(C<sub>1</sub>+C<sub>2</sub>)]U
        
      </div> 
    </form><br></br>
    <div className={props.buttons}>
         
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDfourteen'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDfourteen'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDfourteen'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwelve'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirteen)