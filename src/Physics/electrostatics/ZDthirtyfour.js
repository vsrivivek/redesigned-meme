...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtythree()
    ...
    <form>
    <p><i>Question No.34</i><br></br>A negative charge is placed at the centre of the non-conducting sphere. The direction of electric field on any point at the surface of the sphere is</p>
      <div>
        <input
          type="radio"
          value="a"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> Along the tagent to the surface
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyfive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtyfive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtyfive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtythree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtyfour)