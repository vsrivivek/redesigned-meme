...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   <div className={props.header} style={bStyle}>
    ...
    <form>
    <p><i>Question No.7</i><br></br> A uniform electric field having a magnitude E<sub>0</sub> and direcction along positive X-axis exists. If the potential V is zero t x=0, then its value at x=+x will be
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDsix'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDseven)