...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtysix()
    ...
    <form>
    <p><i>Question No.37</i><br></br>Consider horizontal sheet with charge density 5x10<sup>-6</sup>C/m<sup>2</sup>. A particle of mass 8x10<sup>-6</sup> is dropped from a certain height onto this sheet. The number of electrons that should be removed from this particle so that it stays close to the sheet without falling on it is [g= 10ms<sup>-2</sup> and 1/(4{'\u03c0'}{'\u03b5'}<sub>0</sub>)=9x10<sup>9</sup>N-m<sup>2</sup>c<sup>-2</sup>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyeight'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtyeight'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtyeight'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtysix'))}>Previous</button>
        </div>
        </div> 
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtyseven)