...
const button=<button style={wStyle1} onClick={()=>navigate('/ZDsummary')}>Summary</button>;
...
const mapStateToProps=state=>{
    ...
    export default connect (mapStateToProps,mapDispatchToProps) (ZDscore)