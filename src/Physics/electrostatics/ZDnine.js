...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFoureight()
    ...
    <form>
    <p><i>Question No.9</i><br></br> A particle 'A' of charge '+q' and a particle 'B' has charge '+4q',each having the same mass 'm'. When allowed to fall from rest through the same electric potential difference, the ratio of the speed of 'A' to that of 'B' will be 
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDten'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDten'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDten'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDeight'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDnine)