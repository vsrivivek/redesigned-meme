...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFournineteen()
    ...
    <form>
    <p><i>Question No.20</i><br></br>If the electric flux entering and leaving an enclosed surface respectively is {'\u03a6'}<sub>1</sub> and {'\u03a6'}<sub>2</sub>,the electric charge inside the surface will be </p>
      <div>
        <input
          type="radio"
          value="a"
        ...
        /> ({'\u03a6'}<sub>2</sub>-{'\u03a6'}<sub>1</sub>)/{'\u03b5'}<sub>0</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> ({'\u03a6'}<sub>1</sub>-{'\u03a6'}<sub>2</sub>)/{'\u03b5'}<sub>0</sub>
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> {'\u03b5'}<sub>0</sub>({'\u03a6'}<sub>1</sub>+{'\u03a6'}<sub>2</sub>)
      </div>
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyone'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentyone'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentyone'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDnineteen'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwenty)