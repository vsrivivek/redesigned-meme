...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthree()
    ...
    <form>
    <p><i>Question No.4</i><br></br>The radius of a hollow metallic sphere is 'R'. If the potential difference between its surface and a point at distance of 3R from its centre is V, then the electric field intensity at a distance of 3R from its centr is</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>    
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDFive'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDFive'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDFive'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthree'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDFour)