...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtynine()
    ...
    <form>
    <p><i>Question No.40</i><br></br> The radii of spheres A and B are 'a' and 'b' respectively. They are at equal electric potential. If {'\u03c3'}<sub>A</sub>,{'\u03c3'}<sub>B</sub> be surface charge density of A and B respectively, the {'\u03c3'}<sub>A</sub>/{'\u03c3'}<sub>B</sub> is
</p>
      <div>
        <input
          type="radio"
      ...
      <div>
        <input
          ...
          onClick={handleChange}
        /> b<sup>2</sup>/a<sup>2</sup>
      </div>
       
      
    </form><br></br>
    <div className={props.buttons}>
    <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtynine'))}>Previous</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtynine'))}>Save & Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDforty)