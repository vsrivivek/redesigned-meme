...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourtwentyone()
    ...
    <form>
    <p><i>Question No.22</i><br></br> There is a uniform electric field of strength 10<sup>3</sup>Vm<sup>-1</sup> along Y-axis. A body of mass 1gm and charge 10<sup>-6</sup>C is projected into the field from origin along the positive X-axis with a velocity of 10ms<sup>-1</sup>. Its speed in ms<sup>-1</sup> after 10s is (Neglect gravitation)</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentythree'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwentythree'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwentythree'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwentyone'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDtwentytwo)