...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfour()
    ...
    <form>
    <p><i>Question No.35</i><br></br>A spherical drop of liquid carrying charge Q has potential V<sub>0</sub> at its surface. If two drops of same charge and radius combine to form a single spherical drop, then the potential at the surfacce of the new drop is (Assume V=0 at infinity)
</p>
      <div>
        <input
          type="radio"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtysix'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtysix'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtysix'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyfour'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtyfive)