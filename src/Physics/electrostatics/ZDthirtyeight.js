...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyseven()
    ...
    <form>
    <p><i>Question No.38</i><br></br>An electric dipole of length 5cm is placed in a uniform electric field of 5x10<sup>5</sup>N/C at an angle of 30<sup>o</sup> with the charges +10mC and -10mC on the dipole. the dipole experiences a torque of</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtynine'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtynine'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtynine'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyseven'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtyeight)