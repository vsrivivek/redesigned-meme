...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourthirtyfive()
    ...
    <form>
    <p><i>Question No.36</i><br></br> A spherical volume contains a uniformly distributed charge of density 1.0x10<sup>-6</sup>C/m<sup>3</sup>. Find the electric field(in N/C) at a point inside the volume at a distance 1 mm from the centre [1/(4{'\u03c0'}{'\u03b5'}<sub>0</sub>)=9x10<sup>9</sup>N-m<sup>2</sup>c<sup>-2</sup>]</p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyseven'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDthirtyseven'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDthirtyseven'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDthirtyfive'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDthirtysix)