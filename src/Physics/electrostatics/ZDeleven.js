...
const clickHanlderSan = function handleClickSan(){
  ...
  if (stat==="Not Visited"){
   ...
   props.btnFourten()
    ...
    A cube of side 'b' has a charge 'q' at each end of its vertices. The electric field due to this charge contribution at the centre of the cube is </p>
      <div>
        <input
          type="radio"
          value="a"
    ...
    <div className={props.buttons}>
        ...
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDtwelve'))}>Next</button>
        <button onClick={()=>(clickHanlderMfr)(navigate('/ZDtwelve'))}>Mark For Review</button>
        <button onClick={()=>(clickHanlderSan)(navigate('/ZDtwelve'))}>Save & Next</button>
        <button onClick={()=>(clickHanlderNext)(navigate('/ZDten'))}>Previous</button>
...
export default connect(mapStateToProps,mapDispatchToProps) (ZDeleven)