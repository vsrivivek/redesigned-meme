...
<div style={dStyle}><button style={bstyle} onClick={()=>(clickHandler)(navigate('/ZDscore'))}>Score Page</button></div>
</div>
{/* <p>{props.score}</p> */}
</div>
  )
...
const mapStateToProps=state=>{
    ...
    export default connect(mapStateToProps,mapDispatchToProps) (ZDtimeup)